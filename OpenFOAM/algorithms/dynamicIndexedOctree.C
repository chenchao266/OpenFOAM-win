...
template<class Type>
bool dynamicIndexedOctree<Type>::overlaps
(
    const point& p0,
    const point& p1,
...
template<class Type>
void dynamicIndexedOctree<Type>::divide
(
...
template<class Type>
typename dynamicIndexedOctree<Type>::node
dynamicIndexedOctree<Type>::divide
(
    const treeBoundBox& bb,
...
template<class Type>
void dynamicIndexedOctree<Type>::recursiveSubDivision
(
...
template<class Type>
volumeType dynamicIndexedOctree<Type>::calcVolumeType
(
    const label nodeI
) const
{
...
template<class Type>
volumeType dynamicIndexedOctree<Type>::getVolumeType
(
    const label nodeI,
    const point& sample
) const
...
template<class Type>
volumeType dynamicIndexedOctree<Type>::getSide
(
...
template<class Type>
void dynamicIndexedOctree<Type>::findNearest
(
    const label nodeI,
    const point& sample,
...
template<class Type>
treeBoundBox dynamicIndexedOctree<Type>::subBbox
(
...
template<class Type>
point dynamicIndexedOctree<Type>::pushPoint
(
    const treeBoundBox& bb,
    const point& pt,
...
template<class Type>
point dynamicIndexedOctree<Type>::pushPointIntoFace
(
    const treeBoundBox& bb,
...
template<class Type>
bool dynamicIndexedOctree<Type>::walkToParent
(
    const label nodeI,
    const direction octant,
...
template<class Type>
bool dynamicIndexedOctree<Type>::walkToNeighbour
(
...
template<class Type>
word dynamicIndexedOctree<Type>::faceString
(
    const direction faceID
)
{
...
template<class Type>
void dynamicIndexedOctree<Type>::traverseNode
(
    const bool findAny,
...
template<class Type>
pointIndexHit dynamicIndexedOctree<Type>::findLine
(
    const bool findAny,
    const point& treeStart,
    const point& treeEnd,
...
template<class Type>
void dynamicIndexedOctree<Type>::findBox
(
    const label nodeI,
...
template<class Type>
void dynamicIndexedOctree<Type>::findSphere
(
    const label nodeI,
    const point& centre,
...
void dynamicIndexedOctree<Type>::findNear
(
...
template<class Type>
label dynamicIndexedOctree<Type>::countElements
(
...
template<class Type>
void dynamicIndexedOctree<Type>::writeOBJ
(
    const label nodeI,
    const direction octant
) const
{
    OFstream str
    (
        "node" + name(nodeI) + "_octant" + name(octant) + ".obj"
    );
...
template<class Type>
dynamicIndexedOctree<Type>::dynamicIndexedOctree
(
    const Type& shapes,
    const treeBoundBox& bb,
...
template<class Type>
scalar& dynamicIndexedOctree<Type>::perturbTol()
{
    return perturbTol_;
}
...
template<class Type>
pointIndexHit dynamicIndexedOctree<Type>::findNearest
(
    const point& sample,
...
template<class Type>
pointIndexHit dynamicIndexedOctree<Type>::findLineAny
(
    const point& start,
    const point& end
) const
...
template<class Type>
labelList dynamicIndexedOctree<Type>::findBox
(
    const treeBoundBox& searchBox
) const
{
...
template<class Type>
labelList dynamicIndexedOctree<Type>::findSphere
(
    const point& centre,
    const scalar radiusSqr
) const
...
template<class Type>
labelBits dynamicIndexedOctree<Type>::findNode
(
    const label nodeI,
    const point& sample
) const
...
template<class Type>
label dynamicIndexedOctree<Type>::findInside
(
    const point& sample
) const
{
...
template<class Type>
const labelList& dynamicIndexedOctree<Type>::findIndices
(
    const point& sample
) const
{
...
template<class Type>
bool dynamicIndexedOctree<Type>::insert(label startIndex, label endIndex)
{
...
template<class Type>
bool dynamicIndexedOctree<Type>::insertIndex
(
...
template<class Type>
bool dynamicIndexedOctree<Type>::remove(const label index)
{
    if (nodes_.empty())
    {
        return false;
...
template<class Type>
label dynamicIndexedOctree<Type>::removeIndex
(
    const label nodIndex,
    const label index
)
...
template<class Type>
void dynamicIndexedOctree<Type>::print
(
    prefixOSstream& os,
...
template<class Type>
void dynamicIndexedOctree<Type>::writeTreeInfo() const
{
    label nEntries = 0;
    forAll(contents_, i)
    {
...
template<class Type>
bool dynamicIndexedOctree<Type>::write(Ostream& os) const
{
    os << *this;
...
template<class Type>
Ostream&
operator<<(Ostream& os, const dynamicIndexedOctree<Type>& t)
{
