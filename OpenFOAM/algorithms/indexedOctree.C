...
template<class Type>
typename indexedOctree<Type>::node
indexedOctree<Type>::divide
(
    const treeBoundBox& bb,
...
template<class Type>
volumeType indexedOctree<Type>::calcVolumeType
(
    const label nodeI
) const
{
...
template<class Type>
volumeType indexedOctree<Type>::getVolumeType
(
    const label nodeI,
    const point& sample
) const
...
template<class Type>
volumeType indexedOctree<Type>::getSide
(
...
template<class Type>
treeBoundBox indexedOctree<Type>::subBbox
(
...
template<class Type>
point indexedOctree<Type>::pushPoint
(
    const treeBoundBox& bb,
    const point& pt,
...
template<class Type>
point indexedOctree<Type>::pushPointIntoFace
(
    const treeBoundBox& bb,
...
template<class Type>
bool indexedOctree<Type>::walkToParent
(
    const label nodeI,
    const direction octant,
...
template<class Type>
word indexedOctree<Type>::faceString
(
    const direction faceID
)
{
...
template<class Type>
void indexedOctree<Type>::findSphere
(
    const label nodeI,
    const point& centre,
...
void indexedOctree<Type>::findNear
(
...
template<class Type>
label indexedOctree<Type>::countElements
(
...
template<class Type>
scalar& indexedOctree<Type>::perturbTol()
{
    return perturbTol_;
}
...
template<class Type>
labelList indexedOctree<Type>::findBox
(
    const treeBoundBox& searchBox
) const
{
...
template<class Type>
labelList indexedOctree<Type>::findSphere
(
    const point& centre,
    const scalar radiusSqr
) const
...
template<class Type>
const labelList& indexedOctree<Type>::findIndices
(
    const point& sample
) const
{
