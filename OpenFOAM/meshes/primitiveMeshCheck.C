...
scalar primitiveMesh::planarCosAngle_   = 1.0e-6;
...
bool primitiveMesh::checkConcaveCells
(
    const vectorField& fAreas,
...
scalar primitiveMesh::setClosedThreshold(const scalar val)
{
...
scalar primitiveMesh::setAspectThreshold(const scalar val)
{
...
scalar primitiveMesh::setNonOrthThreshold(const scalar val)
{
...
scalar primitiveMesh::setSkewThreshold(const scalar val)
{
