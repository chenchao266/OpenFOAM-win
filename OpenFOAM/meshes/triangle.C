...
inline void triangle<Point, PointRef>::triSliceWithPlane
(
    const plane& pln,
    const triPoints& tri,
    AboveOp& aboveOp,
...
template<class Point, class PointRef>
template<class AboveOp, class BelowOp>
inline void triangle<Point, PointRef>::sliceWithPlane
(
    const plane& pl,
    AboveOp& aboveOp,
    BelowOp& belowOp
...
inline void triangle<Point, PointRef>::triangleOverlap
(
    const vector& n,
