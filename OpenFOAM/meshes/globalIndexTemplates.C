...
template<class Type, class OutputContainer>
OutputContainer globalIndex::mpiGather
(
    const UList<Type>& sendData,
    const label comm
) const
