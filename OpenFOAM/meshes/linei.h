...
inline line<Point, PointRef>::line(const Point& from, const Point& to)
:
    a_(from),
    b_(to)
{}
...
template<class Point, class PointRef>
inline line<Point, PointRef>::line
(
...
template<class Point, class PointRef>
inline PointRef line<Point, PointRef>::first() const noexcept
{
    return a_;
}
...
template<class Point, class PointRef>
inline PointRef line<Point, PointRef>::second() const noexcept
{
    return b_;
}
...
template<class Point, class PointRef>
inline PointRef line<Point, PointRef>::last() const noexcept
{
    return b_;
}
...
template<class Point, class PointRef>
inline PointRef line<Point, PointRef>::start() const noexcept
{
    return first();
}

template<class Point, class PointRef>
inline PointRef line<Point, PointRef>::end() const noexcept
{
    return second();
}
...
template<class Point, class PointRef>
inline Point line<Point, PointRef>::unitVec() const
{
    const Point v = (b_ - a_);
...
template<class Point, class PointRef>
PointHit<Point> line<Point, PointRef>::nearestDist
(
    const Point& p
) const
{
...
) const
{
    ...
    Point crossab = a ^ b;
    const scalar magCrossSqr = magSqr(crossab);
