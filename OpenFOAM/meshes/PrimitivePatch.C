...
PrimitivePatch<FaceList, PointField>::PrimitivePatch
(
...
template<class FaceList, class PointField>
PrimitivePatch<FaceList, PointField>::PrimitivePatch::~PrimitivePatch()
{
    clearOut();
}
...
template<class FaceList, class PointField>
void
PrimitivePatch<FaceList, PointField>::movePoints
(
...
template<class FaceList, class PointField>
const edgeList&
PrimitivePatch<FaceList, PointField>::edges() const
{
    if (!edgesPtr_)
    {
        calcAddressing();
...
template<class FaceList, class PointField>
const edgeList::subList
PrimitivePatch<FaceList, PointField>::internalEdges() const
{
...
template<class FaceList, class PointField>
const edgeList::subList
PrimitivePatch<FaceList, PointField>::boundaryEdges() const
{
    const edgeList& allEdges = this->edges();  // Force demand-driven
...
template<class FaceList, class PointField>
label
PrimitivePatch<FaceList, PointField>::nInternalEdges() const
{
    if (!edgesPtr_)
    {
        calcAddressing();
...
template<class FaceList, class PointField>
label
PrimitivePatch<FaceList, PointField>::nBoundaryEdges() const
{
    const edgeList& allEdges = this->edges();  // Force demand-driven
...
template<class FaceList, class PointField>
const labelList&
PrimitivePatch<FaceList, PointField>::boundaryPoints() const
{
...
template<class FaceList, class PointField>
const labelListList&
PrimitivePatch<FaceList, PointField>::faceFaces() const
{
    if (!faceFacesPtr_)
    {
        calcAddressing();
...
template<class FaceList, class PointField>
const labelListList&
PrimitivePatch<FaceList, PointField>::edgeFaces() const
{
    if (!edgeFacesPtr_)
    {
        calcAddressing();
...
template<class FaceList, class PointField>
const labelListList&
PrimitivePatch<FaceList, PointField>::faceEdges() const
{
    if (!faceEdgesPtr_)
    {
        calcAddressing();
...
template<class FaceList, class PointField>
const labelListList&
PrimitivePatch<FaceList, PointField>::pointEdges() const
{
    if (!pointEdgesPtr_)
    {
        calcPointEdges();
...
template<class FaceList, class PointField>
const labelListList&
PrimitivePatch<FaceList, PointField>::pointFaces() const
{
    if (!pointFacesPtr_)
    {
        calcPointFaces();
...
>&
PrimitivePatch<FaceList, PointField>::localFaces() const
{
    if (!localFacesPtr_)
    {
        calcMeshData();
...
template<class FaceList, class PointField>
const labelList&
PrimitivePatch<FaceList, PointField>::meshPoints() const
{
    if (!meshPointsPtr_)
    {
        calcMeshData();
...
template<class FaceList, class PointField>
const Map<label>&
PrimitivePatch<FaceList, PointField>::meshPointMap() const
{
    if (!meshPointMapPtr_)
    {
        calcMeshPointMap();
...
>&
PrimitivePatch<FaceList, PointField>::localPoints() const
{
    if (!localPointsPtr_)
    {
        calcLocalPoints();
...
template<class FaceList, class PointField>
const labelList&
PrimitivePatch<FaceList, PointField>::localPointOrder() const
{
...
template<class FaceList, class PointField>
label
PrimitivePatch<FaceList, PointField>::whichPoint
(
    const label gp
) const
{
...
<
    typename PrimitivePatch<FaceList, PointField>::point_type
>&
PrimitivePatch<FaceList, PointField>::faceCentres() const
{
    if (!faceCentresPtr_)
    {
        calcFaceCentres();
...
<
    typename PrimitivePatch<FaceList, PointField>::point_type
>&
PrimitivePatch<FaceList, PointField>::faceAreas() const
{
    if (!faceAreasPtr_)
    {
        calcFaceAreas();
...
template<class FaceList, class PointField>
const Field<scalar>&
PrimitivePatch<FaceList, PointField>::magFaceAreas() const
{
    if (!magFaceAreasPtr_)
    {
        calcMagFaceAreas();
...
<
    typename PrimitivePatch<FaceList, PointField>::point_type
>&
PrimitivePatch<FaceList, PointField>::faceNormals() const
{
    if (!faceNormalsPtr_)
    {
        calcFaceNormals();
...
<
    typename PrimitivePatch<FaceList, PointField>::point_type
>&
PrimitivePatch<FaceList, PointField>::pointNormals() const
{
    if (!pointNormalsPtr_)
    {
        calcPointNormals();
...
template<class FaceList, class PointField>
void
PrimitivePatch<FaceList, PointField>::operator=
(
