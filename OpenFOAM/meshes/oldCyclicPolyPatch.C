...
pointField oldCyclicPolyPatch::getAnchorPoints
(
    const UList<face>& faces,
    const pointField& points
)
...
label oldCyclicPolyPatch::findMaxArea
(
    const pointField& points,
...
bool oldCyclicPolyPatch::getGeometricHalves
(
...
void oldCyclicPolyPatch::getCentresAndAnchors
(
    const primitivePatch& pp,
...
bool oldCyclicPolyPatch::matchAnchors
(
    const bool report,
    const primitivePatch& pp,
...
label oldCyclicPolyPatch::getConsistentRotationFace
(
...
void oldCyclicPolyPatch::initGeometry(PstreamBuffers& pBufs)
{
    polyPatch::initGeometry(pBufs);
}


void oldCyclicPolyPatch::calcGeometry
(
...
void oldCyclicPolyPatch::calcGeometry(PstreamBuffers& pBufs)
{}


void oldCyclicPolyPatch::initMovePoints
(
...
void oldCyclicPolyPatch::movePoints
(
    PstreamBuffers& pBufs,
    const pointField& p
)
...
void oldCyclicPolyPatch::initUpdateMesh(PstreamBuffers& pBufs)
{
    polyPatch::initUpdateMesh(pBufs);
}


void oldCyclicPolyPatch::updateMesh(PstreamBuffers& pBufs)
{
    polyPatch::updateMesh(pBufs);
}


void oldCyclicPolyPatch::initOrder
(
    PstreamBuffers&,
    const primitivePatch& pp
) const
