...
label globalPoints::countPatchPoints
(
...
label globalPoints::findSamePoint
(
...
labelPairList globalPoints::addSendTransform
(
    const label patchi,
...
label globalPoints::meshToLocalPoint
(
...
label globalPoints::localToMeshPoint
(
...
bool globalPoints::storeInitialInfo
(
    const labelPairList& nbrInfo,
    const label localPointi
)
...
void globalPoints::printProcPoint
(
    const labelList& patchToMeshPoint,
...
void globalPoints::printProcPoints
(
    const labelList& patchToMeshPoint,
...
void globalPoints::initOwnPoints
(
...
void globalPoints::sendPatchPoints
(
...
void globalPoints::receivePatchPoints
(
    const bool mergeSeparated,
    const Map<label>& meshToPatchPoint,
    const labelList& patchToMeshPoint,
...
labelList globalPoints::reverseMeshPoints
(
...
void globalPoints::calculateSharedPoints
(
    const Map<label>& meshToPatchPoint, // from mesh point to local numbering
