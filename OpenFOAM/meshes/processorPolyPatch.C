...
namespace Foam
{
    ...
    word processorPolyPatch::newName
    (
    ...
    void processorPolyPatch::initGeometry(PstreamBuffers& pBufs)
    {
        if (Pstream::parRun())
        {
    ...
    void processorPolyPatch::calcGeometry(PstreamBuffers& pBufs)
    {
        if (Pstream::parRun())
        {
            {
    ...
    void processorPolyPatch::initMovePoints
    (
    ...
    void processorPolyPatch::movePoints
    (
        PstreamBuffers& pBufs,
        const pointField&
    )
    ...
    void processorPolyPatch::initUpdateMesh(PstreamBuffers& pBufs)
    {
    ...
    void processorPolyPatch::updateMesh(PstreamBuffers& pBufs)
    {
        // For completeness
    ...
    label processorPolyPatch::matchFace
    (
        const face& a,
