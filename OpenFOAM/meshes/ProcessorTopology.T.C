...
namespace Foam {
    ...
    labelList ProcessorTopology<Container, ProcPatch>::procNeighbours
    (
        const label nProcs,
    ...
    template<class Container, class ProcPatch>
    ProcessorTopology<Container, ProcPatch>::ProcessorTopology
    (
        const Container& patches,
        const label comm
    )
    ...
    template<class Container, class ProcPatch>
    lduSchedule
        ProcessorTopology<Container, ProcPatch>::nonBlockingSchedule
        (
            const Container& patches
        )
    {
