...
namespace Foam
{
    ...
    int ZoneMesh<ZoneType, MeshType>::disallowGenericZones
    (
    ...
    template<class ZoneType, class MeshType>
    bool ZoneMesh<ZoneType, MeshType>::hasGroupIDs() const
    {
        if (groupIDsPtr_)
        {
            // Use existing cache
    ...
    template<class ZoneType, class MeshType>
    void ZoneMesh<ZoneType, MeshType>::calcGroupIDs() const
    {
        if (groupIDsPtr_)
        {
    ...
    template<class ZoneType, class MeshType>
    bool ZoneMesh<ZoneType, MeshType>::read()
    {
        if
            (
    ...
    template<class ZoneType, class MeshType>
    const Map<label>&
        ZoneMesh<ZoneType, MeshType>::zoneMap() const
    {
        if (!zoneMapPtr_)
        {
            calcZoneMap();
    ...
    template<class ZoneType, class MeshType>
    label ZoneMesh<ZoneType, MeshType>::whichZone
    (
    ...
    template<class ZoneType, class MeshType>
    wordList ZoneMesh<ZoneType, MeshType>::names
    (
    ...
    template<class ZoneType, class MeshType>
    wordList ZoneMesh<ZoneType, MeshType>::sortedNames() const
    {
    ...
    template<class ZoneType, class MeshType>
    wordList ZoneMesh<ZoneType, MeshType>::sortedNames
    (
        const wordRe& matcher
    ) const
    {
    ...
    template<class ZoneType, class MeshType>
    labelList ZoneMesh<ZoneType, MeshType>::indices
    (
        const wordRe& matcher,
    ...
    template<class ZoneType, class MeshType>
    label ZoneMesh<ZoneType, MeshType>::findIndex
    (
        const wordRe& key
    ) const
    {
    ...
    template<class ZoneType, class MeshType>
    label ZoneMesh<ZoneType, MeshType>::findZoneID
    (
        const word& zoneName
    ) const
    {
    ...
    template<class ZoneType, class MeshType>
    const ZoneType* ZoneMesh<ZoneType, MeshType>::cfindZone
    (
        const word& zoneName
    ) const
    {
    ...
    template<class ZoneType, class MeshType>
    ZoneType* ZoneMesh<ZoneType, MeshType>::findZone
    (
        const word& zoneName
    )
    {
    ...
    template<class ZoneType, class MeshType>
    bitSet ZoneMesh<ZoneType, MeshType>::selection
    (
    ...
    const HashTable<labelList>&
        ZoneMesh<ZoneType, MeshType>::groupZoneIDs() const
    {
        if (!groupIDsPtr_)
        {
            calcGroupIDs();
    ...
    template<class ZoneType, class MeshType>
    void ZoneMesh<ZoneType, MeshType>::setGroup
    (
    ...
    template<class ZoneType, class MeshType>
    bool ZoneMesh<ZoneType, MeshType>::checkDefinition
    (
        const bool report
    ) const
    {
    ...
    template<class ZoneType, class MeshType>
    bool ZoneMesh<ZoneType, MeshType>::checkParallelSync
    (
        const bool report
    ) const
    {
    ...
    template<class ZoneType, class MeshType>
    void ZoneMesh<ZoneType, MeshType>::movePoints(const pointField& pts)
    {
        PtrList<ZoneType>& zones = *this;
    ...
    template<class ZoneType, class MeshType>
    void ZoneMesh<ZoneType, MeshType>::updateMetaData()
    {
    ...
    template<class ZoneType, class MeshType>
    const ZoneType& ZoneMesh<ZoneType, MeshType>::operator[]
    (
        const word& zoneName
        ) const
    {
    ...
    template<class ZoneType, class MeshType>
    ZoneType& ZoneMesh<ZoneType, MeshType>::operator[]
    (
        const word& zoneName
        )
    {
