...
// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //
 ...
 namespace Foam{
PtrList<cellModel> cellModel::models_;

List<const cellModel*> cellModel::modelPtrs_;

const Enum<cellModel::modelType> cellModel::modelNames
({
...
void cellModel::constructModels()
{
    if (models_.size())
    {
...
const cellModel* cellModel::ptr(const modelType model)
{
    return ptr(label(model));
}


const cellModel* cellModel::ptr(const word& modelName)
{
    if (models_.empty())
    {
        constructModels();
...
const cellModel* cellModel::ptr(const label modelIndex)
{
    if (models_.empty())
    {
        constructModels();
...
const cellModel& cellModel::ref(const modelType model)
{
...
const cellModel& cellModel::ref(const word& modelName)
{
...
const cellModel& cellModel::ref(const label modelIndex)
{
