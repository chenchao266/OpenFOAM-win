...
edge
PrimitivePatch<FaceList, PointField>::meshEdge(const label edgei) const
{
    return edge(this->meshPoints(), this->edges()[edgei]);
}


template<class FaceList, class PointField>
edge
PrimitivePatch<FaceList, PointField>::meshEdge(const edge& e) const
{
    return edge(this->meshPoints(), e);
}
...
template<class FaceList, class PointField>
label
PrimitivePatch<FaceList, PointField>::meshEdge
(
    const label edgei,
    const edgeList& allEdges,
    const labelListList& pointEdges
...
template<class FaceList, class PointField>
label
PrimitivePatch<FaceList, PointField>::findEdge
(
    const edge& e
) const
{
