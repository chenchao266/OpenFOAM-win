...
namespace Foam {
    ...
    ) const
    {
...

        {
            ...
            if
                (
                    ...
                    && magSqr(d_ - ctr) <= facSqr * radiusSqr
                    )
            {
                pHit.setMiss(false);
                pHit.setPoint(ctr);
        ...
        }
        {
            ...
            if
                (
                    radiusSqr < minRadiusSqr
                    && magSqr(c_ - ctr) <= facSqr * radiusSqr
                    )
            {
                pHit.setMiss(false);
                pHit.setPoint(ctr);
        ...
        }
        {
            ...
            if
                (
                    radiusSqr < minRadiusSqr
                    && magSqr(b_ - ctr) <= facSqr * radiusSqr
                    )
            {
                pHit.setMiss(false);
                pHit.setPoint(ctr);
        ...
        }
        {
            ...
            if
                (
                    radiusSqr < minRadiusSqr
                    && magSqr(a_ - ctr) <= facSqr * radiusSqr
                    )
            {
                pHit.setMiss(false);
                pHit.setPoint(ctr);
    ...
    template<class Point, class PointRef>
    void tetrahedron<Point, PointRef>::gradNiSquared
    (
        scalarField& buffer
    ) const
    {
    ...
    template<class Point, class PointRef>
    void tetrahedron<Point, PointRef>::gradNiDotGradNj
    (
        scalarField& buffer
    ) const
    {
    ...
    template<class Point, class PointRef>
    void tetrahedron<Point, PointRef>::gradNiGradNi
    (
        tensorField& buffer
    ) const
    {
    ...
    template<class Point, class PointRef>
    void tetrahedron<Point, PointRef>::gradNiGradNj
    (
        tensorField& buffer
    ) const
    {
    ...
    template<class Point, class PointRef>
    boundBox tetrahedron<Point, PointRef>::bounds() const
    {
        return
            boundBox
            (
