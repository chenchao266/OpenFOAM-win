...
void globalMeshData::initProcAddr()
{
...
void globalMeshData::calcSharedPoints() const
{
    if
    (
        nGlobalPoints_ != -1
...
void globalMeshData::countSharedEdges
(
...
void globalMeshData::calcSharedEdges() const
{
            ...
            )
            {
                ...
                if (debug)
                {
                    Pout<< "globalMeshData::calcSharedEdges : "
                        ...
                        << name(slave) << " : " << procSharedEdges.size()
                        << endl;
                }
...
void globalMeshData::calcGlobalPointSlaves() const
{
    if (debug)
    {
...
void globalMeshData::calcPointConnectivity
(
...
void globalMeshData::calcGlobalPointEdges
(
...
label globalMeshData::findTransform
(
...
void globalMeshData::calcGlobalEdgeSlaves() const
{
    if (debug)
    {
...
void globalMeshData::calcGlobalEdgeOrientation() const
{
    if (debug)
    {
...
void globalMeshData::calcPointBoundaryFaces
(
...
void globalMeshData::calcGlobalPointBoundaryFaces() const
{
    if (debug)
    {
...
void globalMeshData::calcGlobalPointBoundaryCells() const
{
    if (debug)
    {
...
void globalMeshData::calcGlobalCoPointSlaves() const
{
    if (debug)
    {
...
pointField globalMeshData::sharedPoints() const
{
...
pointField globalMeshData::geometricSharedPoints() const
{
...
label globalMeshData::nGlobalPoints() const
{
    if (nGlobalPoints_ == -1)
    {
        calcSharedPoints();
...
label globalMeshData::nGlobalEdges() const
{
    if (nGlobalEdges_ == -1)
    {
        calcSharedEdges();
...
void globalMeshData::movePoints(const pointField& newPoints)
{
...
void globalMeshData::updateMesh()
{
    // Clear out old data
    clearOut();
