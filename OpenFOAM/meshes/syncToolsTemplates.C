...
//void syncTools::syncPointPositions
//(
//    const polyMesh& mesh,
...
//template<class CombineOp>
//void syncTools::syncEdgePositions
//(
//    const polyMesh& mesh,
...
template<class T, class CombineOp, class TransformOp>
void syncTools::syncBoundaryFaceList
(
    const polyMesh& mesh,
    UList<T>& faceValues,
    const CombineOp& cop,
...
template<class T>
void syncTools::swapBoundaryCellList
(
    const polyMesh& mesh,
