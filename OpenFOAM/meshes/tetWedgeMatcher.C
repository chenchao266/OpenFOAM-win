...
const label tetWedgeMatcher::vertPerCell = 5;
const label tetWedgeMatcher::facePerCell = 4;
const label tetWedgeMatcher::maxVertPerFace = 4;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

tetWedgeMatcher::tetWedgeMatcher() :    cellMatcher
    (
        vertPerCell,
        facePerCell,
        maxVertPerFace,
...
bool tetWedgeMatcher::matchShape
(
...
label tetWedgeMatcher::faceHashValue() const
{
    return 2*3 + 2*4;
}


bool tetWedgeMatcher::faceSizeMatch
(
    const faceList& faces,
    const labelList& myFaces
) const
...
bool tetWedgeMatcher::isA(const primitiveMesh& mesh, const label celli)
{
    return matchShape
    (
        true,
...
bool tetWedgeMatcher::isA(const faceList& faces)
{
