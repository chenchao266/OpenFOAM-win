...
void PrimitivePatch<FaceList, PointField>::visitPointRegion
(
    const label pointi,
...
template<class FaceList, class PointField>
typename PrimitivePatch<FaceList, PointField>::surfaceTopo
PrimitivePatch<FaceList, PointField>::surfaceType() const
{
...
template<class FaceList, class PointField>
bool
PrimitivePatch<FaceList, PointField>::checkTopology
(
    const bool report,
    labelHashSet* setPtr
) const
...
template<class FaceList, class PointField>
bool
PrimitivePatch<FaceList, PointField>::checkPointManifold
(
    const bool report,
    labelHashSet* setPtr
) const
