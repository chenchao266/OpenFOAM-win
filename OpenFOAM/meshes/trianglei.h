...
template<class Point, class PointRef>
inline vector triangle<Point, PointRef>::areaNormal() const
{
...
template<class Point, class PointRef>
inline vector triangle<Point, PointRef>::unitNormal() const
{
...
inline scalar triangle<Point, PointRef>::circumRadius() const
{
    ...
    return 0.5*sqrt(min(GREAT, max(0, a)));
}
...
inline scalar triangle<Point, PointRef>::quality() const
{
    ...
    return mag()/(sqr(c)*3.0*sqrt(3.0)/4.0);
}


template<class Point, class PointRef>
inline scalar triangle<Point, PointRef>::sweptVol
(
    const triangle& t
) const
{
...
template<class Point, class PointRef>
inline Point triangle<Point, PointRef>::barycentricToPoint
(
...
template<class Point, class PointRef>
inline barycentric2D triangle<Point, PointRef>::pointToBarycentric
(
    const point& pt
) const
{
...
template<class Point, class PointRef>
inline scalar triangle<Point, PointRef>::pointToBarycentric
(
    const point& pt,
    barycentric2D& bary
) const
...
) const
{
    ...
    if (triInfo.hit())
    {
        ...
        if (triInfo.distance() > 1)
        {
            ...
            scalar dist = mag(triInfo.hitPoint()-lnInfo.missPoint());
    ...
    else
    {
        ...
        if (mag(nearestLinePoint-ln.start()) < SMALL)
        {
            lnInfo.setMiss(true);
            lnInfo.setPoint(ln.start());
        }
        else if (mag(nearestLinePoint-ln.end()) < SMALL)
        {
            lnInfo.setMiss(true);
            lnInfo.setPoint(ln.end());
        }
...
template<class Point, class PointRef>
inline int triangle<Point, PointRef>::sign
(
    const point& p,
    const scalar tol
) const
...
template<class Point, class PointRef>
inline void triangle<Point, PointRef>::dummyOp::operator()
(
    const triPoints&
)
{}
...
template<class Point, class PointRef>
inline triangle<Point, PointRef>::sumAreaOp::sumAreaOp()
:
    area_(0.0)
{}
...
template<class Point, class PointRef>
inline void triangle<Point, PointRef>::sumAreaOp::operator()
(
    const triPoints& tri
)
{
...
template<class Point, class PointRef>
inline triangle<Point, PointRef>::storeOp::storeOp
(
...
template<class Point, class PointRef>
inline void triangle<Point, PointRef>::storeOp::operator()
(
    const triPoints& tri
)
{
...
template<class Point, class PointRef>
inline point triangle<Point, PointRef>::planeIntersection
(
