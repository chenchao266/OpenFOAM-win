...
template<class Type>
void IjkField<Type>::resize(const labelVector& newSizes)
{
...
template<class Type>
void IjkField<Type>::operator=(const IjkField<Type>& rhs)
{
    if (this != &rhs)
    {
        sizes() = rhs.sizes();
...
template<class Type>
void IjkField<Type>::operator=(const tmp<IjkField<Type>>& rhs)
{
    if (this != &(rhs()))
    {
        sizes() = rhs().sizes();
