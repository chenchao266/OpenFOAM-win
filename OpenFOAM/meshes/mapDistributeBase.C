...
void mapDistributeBase::checkReceivedSize
(
    const label proci,
...
void mapDistributeBase::exchangeAddressing
(
    const int tag,
    const globalIndex& globalNumbering,
    labelList& elements,
...
label mapDistributeBase::renumber
(
    const globalIndex& globalNumbering,
...
Ostream& operator<<(Ostream& os, const mapDistributeBase& map)
{
