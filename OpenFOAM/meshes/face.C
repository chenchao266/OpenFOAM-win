...
namespace Foam
{
    ...
    tmp<vectorField>
        face::calcEdges(const pointField& points) const
    {
    ...
    face::face(const triFace& f) : labelList(f)
    {}
    ...
    point face::centre(const pointField& points) const
    {
    ...
    vector face::normal(const pointField& p) const
    {
        const label nPoints = size();
    ...
    int face::edgeDirection(const edge& e) const
    {
        forAll(*this, i)
        {
    ...
    label face::nTriangles(const pointField&) const
    {
        return nTriangles();
    }
