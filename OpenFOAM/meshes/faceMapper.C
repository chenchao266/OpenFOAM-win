...
label faceMapper::size() const
{
    return mesh_.nFaces();
}


label faceMapper::sizeBeforeMapping() const
{
    return mpm_.nOldFaces();
}


label faceMapper::internalSizeBeforeMapping() const
{
...
const labelList& faceMapper::insertedObjectLabels() const
{
...
const labelHashSet& faceMapper::flipFaceFlux() const
{
    return mpm_.flipFaceFlux();
}


label faceMapper::nOldInternalFaces() const
{
    return mpm_.nOldInternalFaces();
}


const labelList& faceMapper::oldPatchStarts() const
{
    return mpm_.oldPatchStarts();
}


const labelList& faceMapper::oldPatchSizes() const
{
