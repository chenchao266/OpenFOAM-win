...
FieldField<Field, Type>::FieldField() :    PtrList<Field<Type>>()
{}


template<template<class> class Field, class Type>
FieldField<Field, Type>::FieldField(const label size) :    PtrList<Field<Type>>(size)
{}
...
template<template<class> class Field, class Type>
FieldField<Field, Type>::FieldField(const FieldField<Field, Type>& f) :    tmp<FieldField<Field, Type>>::refCount(),
    PtrList<Field<Type>>(f)
{}


template<template<class> class Field, class Type>
FieldField<Field, Type>::FieldField(FieldField<Field, Type>& f, bool reuse) :    PtrList<Field<Type>>(f, reuse)
{}


template<template<class> class Field, class Type>
FieldField<Field, Type>::FieldField(const PtrList<Field<Type>>& tl) :    PtrList<Field<Type>>(tl)
{}


#ifndef NoConstructFromTmp
template<template<class> class Field, class Type>
FieldField<Field, Type>::FieldField(const tmp<FieldField<Field, Type>>& tf) :    PtrList<Field<Type>>
    (
...
template<template<class> class Field, class Type>
FieldField<Field, Type>::FieldField(Istream& is) :    PtrList<Field<Type>>(is)
{}
...
) const
{
    ...
    ::component(Component.ref(), *this, d);
