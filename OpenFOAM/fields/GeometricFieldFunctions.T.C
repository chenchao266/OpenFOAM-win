...
{                                                                              \
    ...
    (                                                                          \
        #func "(" + gf.name() + ')',                                           \
        gf.dimensions(),                                                       \
        func(gFunc(gf.primitiveField()), gFunc(gf.boundaryField()))      \
    );                                                                         \
}                                                                              \
                                                                               \
template<class Type, template<class> class PatchField, class GeoMesh>          \
...
{                                                                              \
    opFunc(gf.primitiveFieldRef(), gf1.primitiveField(), dvs.value());   \
    opFunc(gf.boundaryFieldRef(), gf1.boundaryField(), dvs.value());     \
}                                                                              \
                                                                               \
template                                                                       \
<class Form, class Type, template<class> class PatchField, class GeoMesh>      \
...
{                                                                              \
    opFunc(gf.primitiveFieldRef(), dvs.value(), gf1.primitiveField());   \
    opFunc(gf.boundaryFieldRef(), dvs.value(), gf1.boundaryField());     \
}                                                                              \
                                                                               \
template                                                                       \
<class Form, class Type, template<class> class PatchField, class GeoMesh>      \
