...
namespace Foam {
    template<class Type>
    const word codedFixedValuePointPatchField<Type>::codeTemplateC
        = "fixedValuePointPatchFieldTemplate.C";

    template<class Type>
    const word codedFixedValuePointPatchField<Type>::codeTemplateH
    ...
    template<class Type>
    void codedFixedValuePointPatchField<Type>::setFieldTemplates
    (
        dynamicCode& dynCode
    )
    {
    ...
    template<class Type>
    const IOdictionary& codedFixedValuePointPatchField<Type>::dict()
        const
    {
    ...
    template<class Type>
    dlLibraryTable& codedFixedValuePointPatchField<Type>::libs() const
    {
    ...
    template<class Type>
    void codedFixedValuePointPatchField<Type>::prepare
    (
        dynamicCode& dynCode,
    ...
    template<class Type>
    const dictionary& codedFixedValuePointPatchField<Type>::codeDict()
        const
    {
    ...
    template<class Type>
    string codedFixedValuePointPatchField<Type>::description() const
    {
        return
            "patch "
            + this->patch().name()
    ...
    template<class Type>
    void codedFixedValuePointPatchField<Type>::clearRedirect() const
    {
    ...
    template<class Type>
    codedFixedValuePointPatchField<Type>::codedFixedValuePointPatchField
    (
        const pointPatch& p,
    ...
    const pointPatchField<Type>&
        codedFixedValuePointPatchField<Type>::redirectPatchField() const
    {
    ...
    template<class Type>
    void codedFixedValuePointPatchField<Type>::updateCoeffs()
    {
        if (this->updated())
        {
            return;
    ...
    template<class Type>
    void codedFixedValuePointPatchField<Type>::evaluate
    (
    ...
    template<class Type>
    void codedFixedValuePointPatchField<Type>::write(Ostream& os) const
    {
