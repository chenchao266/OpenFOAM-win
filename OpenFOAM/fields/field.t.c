...
namespace Foam
{
    ...
    template<class Type>
    Field<Type>::Field(const label size, const zero)
        :
        List<Type>(size, Zero)
    {}
    ...
    template<class Type>
    Field<Type>::Field(const UIndirectList<Type>& list)
        :
        List<Type>(list)
    {}
    ...
    VSForm Field<Type>::block(const label start) const
    {
        VSForm vs;
    ...
    template<class Type>
    void Field<Type>::operator=(const zero)
    {
