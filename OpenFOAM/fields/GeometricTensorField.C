...
{
    unzipRow(input.primitiveField(), cmpt, result.primitiveFieldRef());

    unzipRow(input.boundaryField(), cmpt, result.boundaryFieldRef());
}
...
{
    unzipCol(input.primitiveField(), cmpt, result.primitiveFieldRef());

    unzipCol(input.boundaryField(), cmpt, result.boundaryFieldRef());
}
...
{
    unzipDiag(input.primitiveField(), result.primitiveFieldRef());

    unzipDiag(input.boundaryField(), result.boundaryFieldRef());
}
