...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
UniformDimensionedField<Type>::UniformDimensionedField
(
    const IOobject& io,
...
template<class Type>
bool UniformDimensionedField<Type>::readData(Istream& is)
{
    dictionary dict(is);
    scalar multiplier(1);
...
template<class Type>
bool UniformDimensionedField<Type>::writeData(Ostream& os) const
{
    scalar multiplier(1);
...
template<class Type>
void UniformDimensionedField<Type>::operator=
(
