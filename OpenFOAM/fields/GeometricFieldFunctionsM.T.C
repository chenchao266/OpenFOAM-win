...
{                                                                              \
    Func(res.primitiveFieldRef(), gf1.primitiveField());                 \
    Func(res.boundaryFieldRef(), gf1.boundaryField());                   \
}                                                                              \
                                                                               \
TEMPLATE                                                                       \
...
{                                                                              \
    OpFunc(res.primitiveFieldRef(), gf1.primitiveField());               \
    OpFunc(res.boundaryFieldRef(), gf1.boundaryField());                 \
}                                                                              \
                                                                               \
TEMPLATE                                                                       \
...
{                                                                              \
    Func(res.primitiveFieldRef(), dt1.value(), gf2.primitiveField());    \
    Func(res.boundaryFieldRef(), dt1.value(), gf2.boundaryField());      \
}                                                                              \
                                                                               \
TEMPLATE                                                                       \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> Func                      \
...
{                                                                              \
    Func(res.primitiveFieldRef(), gf1.primitiveField(), dt2.value());    \
    Func(res.boundaryFieldRef(), gf1.boundaryField(), dt2.value());      \
}                                                                              \
                                                                               \
TEMPLATE                                                                       \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> Func                      \
...
{                                                                              \
    OpFunc(res.primitiveFieldRef(), dt1.value(), gf2.primitiveField());  \
    OpFunc(res.boundaryFieldRef(), dt1.value(), gf2.boundaryField());    \
}                                                                              \
                                                                               \
TEMPLATE                                                                       \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> operator Op               \
...
{                                                                              \
    OpFunc(res.primitiveFieldRef(), gf1.primitiveField(), dt2.value());  \
    OpFunc(res.boundaryFieldRef(), gf1.boundaryField(), dt2.value());    \
}                                                                              \
                                                                               \
TEMPLATE                                                                       \
tmp<GeometricField<ReturnType, PatchField, GeoMesh>> operator Op               \
