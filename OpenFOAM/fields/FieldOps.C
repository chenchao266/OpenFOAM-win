...
Tuple2<T1,T2> FieldOps::findMinData
(
    const Field<T1>& vals,
    const Field<T2>& data
)
{
    ...
    combineReduce(result, minFirstEqOp<T1>());
    return result;
}


template<class T1, class T2>
Tuple2<T1,T2> FieldOps::findMaxData
(
    const Field<T1>& vals,
    const Field<T2>& data
)
{
    ...
    combineReduce(result, maxFirstEqOp<T1>());
    return result;
}
