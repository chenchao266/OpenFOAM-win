...
{
    zip(result.primitiveFieldRef(), ii.primitiveField());

    zip(result.boundaryFieldRef(), ii.boundaryField());
}
...
{
    unzip(input.primitiveField(), ii.primitiveFieldRef());

    unzip(input.boundaryField(), ii.boundaryFieldRef());
}
