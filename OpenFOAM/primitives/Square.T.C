...
namespace Foam {
    template<class Type>
    void Function1Types::Square<Type>::read(const dictionary& coeffs)
    {
    ...
    template<class Type>
    Function1Types::Square<Type>::Square
    (
    ...
    template<class Type>
    Function1Types::Square<Type>::Square(const Square<Type>& se)
        :
        Function1<Type>(se),
        t0_(se.t0_),
    ...
    template<class Type>
    Type Function1Types::Square<Type>::value(const scalar t) const
    {
    ...
    template<class Type>
    void Function1Types::Square<Type>::writeData(Ostream& os) const
    {
