...
template<class Type>
Function1Types::Sine<Type>::Sine(const Sine<Type>& rhs)
:
    Function1<Type>(rhs),
    t0_(rhs.t0_),
...
template<class Type>
void Function1Types::Sine<Type>::userTimeToTime(const Time& t)
{
...
template<class Type>
void Function1Types::Sine<Type>::writeEntries(Ostream& os) const
{
...
template<class Type>
void Function1Types::Sine<Type>::writeData(Ostream& os) const
{
