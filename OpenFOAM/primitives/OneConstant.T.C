...
namespace Foam {
    template<class Type>
    Function1Types::OneConstant<Type>::OneConstant(const word& entryName)
        :
    ...
    template<class Type>
    Type Function1Types::OneConstant<Type>::value(const scalar x) const
    {
    ...
    template<class Type>
    Type Function1Types::OneConstant<Type>::integrate
    (
        const scalar x1,
        const scalar x2
    ) const
