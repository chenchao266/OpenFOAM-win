...
// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<>
const char* const symmTensor2D::vsType::typeName = "symmTensor2D";

template<>
const char* const symmTensor2D::vsType::componentNames[] =
{
    "xx", "xy",
          "yy"
};
...
template<>
const symmTensor2D symmTensor2D::vsType::vsType::zero_
(
    symmTensor2D::uniform(0)
);

template<>
const symmTensor2D symmTensor2D::vsType::one_
(
    symmTensor2D::uniform(1)
);

template<>
const symmTensor2D symmTensor2D::vsType::max_
(
    symmTensor2D::uniform(VGREAT)
);

template<>
const symmTensor2D symmTensor2D::vsType::min_
(
    symmTensor2D::uniform(-VGREAT)
);

template<>
const symmTensor2D symmTensor2D::vsType::rootMax_
(
    symmTensor2D::uniform(ROOTVGREAT)
);

template<>
const symmTensor2D symmTensor2D::vsType::rootMin_
(
    symmTensor2D::uniform(-ROOTVGREAT)
);
