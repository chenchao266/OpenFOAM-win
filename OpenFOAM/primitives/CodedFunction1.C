...
template<class Type>
dlLibraryTable&
Function1Types::CodedFunction1<Type>::libs() const
{
...
template<class Type>
string
Function1Types::CodedFunction1<Type>::description() const
{
...
template<class Type>
void Function1Types::CodedFunction1<Type>::clearRedirect() const
{
...
template<class Type>
const dictionary&
Function1Types::CodedFunction1<Type>::codeContext() const
{
...
template<class Type>
const dictionary&
Function1Types::CodedFunction1<Type>::codeDict
(
...
template<class Type>
const dictionary&
Function1Types::CodedFunction1<Type>::codeDict() const
{
...
template<class Type>
void Function1Types::CodedFunction1<Type>::prepare
(
    dynamicCode& dynCode,
...
template<class Type>
Function1Types::CodedFunction1<Type>::CodedFunction1
(
...
Function1Types::CodedFunction1<Type>::redirectFunction() const
{
...
template<class Type>
Type Function1Types::CodedFunction1<Type>::value
(
    const scalar x
) const
{
...
template<class Type>
void Function1Types::CodedFunction1<Type>::writeData
(
    Ostream& os
) const
{
