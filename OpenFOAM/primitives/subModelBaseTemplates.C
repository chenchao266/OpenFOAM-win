...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
Type subModelBase::getBaseProperty
(
...
template<class Type>
void subModelBase::getBaseProperty
(
    const word& entryName,
    Type& value
) const
...
template<class Type>
void subModelBase::setBaseProperty
(
    const word& entryName,
    const Type& value
)
...
template<class Type>
void subModelBase::getModelProperty
(
    const word& entryName,
    Type& value
) const
...
template<class Type>
Type subModelBase::getModelProperty
(
    const word& entryName,
    const Type& defaultValue
) const
...
template<class Type>
void subModelBase::setModelProperty
(
    const word& entryName,
    const Type& value
)
