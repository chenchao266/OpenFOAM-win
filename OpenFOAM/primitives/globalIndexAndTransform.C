...
label globalIndexAndTransform::matchTransform
(
...
void globalIndexAndTransform::determineTransformPermutations()
{
...
void globalIndexAndTransform::determinePatchTransformSign()
{
    const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
bool globalIndexAndTransform::uniqueTransform
(
    const point& pt,
...
globalIndexAndTransform::globalIndexAndTransform(const polyMesh& mesh) :    mesh_(mesh),
    transforms_(),
