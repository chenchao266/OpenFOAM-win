...
inline quaternion quaternion::unit(const vector& v)
{
...
inline const vector& quaternion::v() const
{
    return v_;
}


inline scalar& quaternion::w()
{
    return w_;
}


inline vector& quaternion::v()
{
    return v_;
}
...
inline quaternion quaternion::mulq0v(const vector& u) const
{
...
inline quaternion quaternion::invTransform
(
    const quaternion& q
) const
{
...
inline tensor quaternion::R() const
{
...
inline vector quaternion::twoAxes
(
    const scalar t11,
    const scalar t12,
    const scalar c2,
...
inline vector quaternion::threeAxes
(
    const scalar t11,
    const scalar t12,
    const scalar s2,
...
inline void quaternion::operator=(const scalar s)
{
    w_ = s;
}
