...
namespace Foam {
    ...
    const interpolationWeights&
        Function1Types::TableBase<Type>::interpolator() const
    {
    ...
    template<class Type>
    Function1Types::TableBase<Type>::TableBase
    (
        const word& name,
    ...
    template<class Type>
    Function1Types::TableBase<Type>::TableBase(const TableBase<Type>& tbl)
        :
        Function1<Type>(tbl),
        name_(tbl.name_),
    ...
    template<class Type>
    word Function1Types::TableBase<Type>::boundsHandlingToWord
    (
    ...
    template<class Type>
    typename Function1Types::TableBase<Type>::boundsHandling
        Function1Types::TableBase<Type>::wordToBoundsHandling
        (
            const word& bound
        ) const
    {
    ...
    template<class Type>
    typename Function1Types::TableBase<Type>::boundsHandling
        Function1Types::TableBase<Type>::outOfBounds
        (
            const boundsHandling& bound
        )
    {
    ...
    template<class Type>
    void Function1Types::TableBase<Type>::check() const
    {
        if (!table_.size())
        {
    ...
    template<class Type>
    bool Function1Types::TableBase<Type>::checkMinBounds
    (
        const scalar x,
        scalar& xDash
    ) const
    ...
    template<class Type>
    bool Function1Types::TableBase<Type>::checkMaxBounds
    (
        const scalar x,
        scalar& xDash
    ) const
    ...
    template<class Type>
    void Function1Types::TableBase<Type>::convertTimeBase(const Time& t)
    {
        forAll(table_, i)
        {
    ...
    template<class Type>
    Type Function1Types::TableBase<Type>::value(const scalar x) const
    {
        scalar xDash = x;
    ...
    template<class Type>
    Type Function1Types::TableBase<Type>::integrate
    (
        const scalar x1,
        const scalar x2
    ) const
    ...
    template<class Type>
    tmp<scalarField> Function1Types::TableBase<Type>::x() const
    {
    ...
    template<class Type>
    void Function1Types::TableBase<Type>::writeEntries(Ostream& os) const
    {
    ...
    template<class Type>
    void Function1Types::TableBase<Type>::writeData(Ostream& os) const
    {
