...
namespace Foam
{
    ...
    polynomialFunction polynomialFunction::cloneIntegral
    (
    ...
    polynomialFunction polynomialFunction::cloneIntegralMinus1
    (
        const polynomialFunction& poly,
        const scalar intConstant
    )
    ...
    polynomialFunction::polynomialFunction(const label order) : scalarList(order, 0.0),
        logActive_(false),
        logCoeff_(0.0)
    {
        if (this->empty())
    ...
    polynomialFunction::polynomialFunction(const polynomialFunction& poly) : scalarList(poly),
        logActive_(poly.logActive_),
        logCoeff_(poly.logCoeff_)
    {}


    polynomialFunction::polynomialFunction(const UList<scalar>& coeffs) : scalarList(coeffs),
        logActive_(false),
        logCoeff_(0.0)
    {
        if (this->empty())
    ...
    polynomialFunction::polynomialFunction(Istream& is) : scalarList(is),
        logActive_(false),
        logCoeff_(0.0)
    {
        if (this->empty())
    ...
    bool polynomialFunction::logActive() const
    {
        return logActive_;
    }


    scalar polynomialFunction::logCoeff() const
    {
        return logCoeff_;
    }


    scalar polynomialFunction::value(const scalar x) const
    {
    ...
    polynomialFunction
        polynomialFunction::integral(const scalar intConstant) const
    {
    ...
    polynomialFunction
        polynomialFunction::integralMinus1(const scalar intConstant) const
    {
    ...
    polynomialFunction&
        polynomialFunction::operator+=(const polynomialFunction& poly)
    {
    ...
    polynomialFunction&
        polynomialFunction::operator*=(const scalar s)
    {
        scalarList& coeffs = *this;
        forAll(coeffs, i)
        {
    ...
    Ostream& operator<<(Ostream& os, const polynomialFunction& poly)
    {
