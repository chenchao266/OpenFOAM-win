...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
parsing::genericRagelLemonDriver::genericRagelLemonDriver()
:
...
void parsing::genericRagelLemonDriver::clear()
{
    content_ = std::cref<std::string>(string::null);
    start_ = 0;
    length_ = 0;
...
void parsing::genericRagelLemonDriver::content
(
    const std::string& s,
    size_t pos,
    size_t len
...
parsing::genericRagelLemonDriver::cbegin() const
{
...
std::string::const_iterator
parsing::genericRagelLemonDriver::cend() const
{
    const std::string& s = content_.get();
...
Ostream& parsing::genericRagelLemonDriver::printBuffer
(
    Ostream& os
) const
{
...
void parsing::genericRagelLemonDriver::reportFatal
(
