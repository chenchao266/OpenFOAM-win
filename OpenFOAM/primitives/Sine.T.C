...
namespace Foam {
    template<class Type>
    void Function1Types::Sine<Type>::read(const dictionary& coeffs)
    {
    ...
    template<class Type>
    Function1Types::Sine<Type>::Sine(const Sine<Type>& se)
        :
        Function1<Type>(se),
        t0_(se.t0_),
    ...
    template<class Type>
    Type Function1Types::Sine<Type>::value(const scalar t) const
    {
        return
            amplitude_->value(t)
