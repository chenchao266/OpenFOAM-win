...
const Scalar pTraits<Scalar>::zero_ = 0.0;
const Scalar pTraits<Scalar>::one_ = 1.0;
const Scalar pTraits<Scalar>::min_ = -ScalarVGREAT;
const Scalar pTraits<Scalar>::max_ = ScalarVGREAT;
const Scalar pTraits<Scalar>::rootMin_ = -ScalarROOTVGREAT;
const Scalar pTraits<Scalar>::rootMax_ = ScalarROOTVGREAT;
