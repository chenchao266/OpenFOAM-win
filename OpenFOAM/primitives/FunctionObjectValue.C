...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
void Function1Types::FunctionObjectValue<Type>::read
(
...
template<class Type>
Function1Types::FunctionObjectValue<Type>::FunctionObjectValue
(
...
template<class Type>
void Function1Types::FunctionObjectValue<Type>::writeEntries
(
    Ostream& os
) const
{
...
template<class Type>
void Function1Types::FunctionObjectValue<Type>::writeData
(
    Ostream& os
) const
{
