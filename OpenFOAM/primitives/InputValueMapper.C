...
const Enum
<
    typename Function1Types::InputValueMapper<Type>::mappingMode
>
Function1Types::InputValueMapper<Type>::mappingModeNames_
({
...
template<class Type>
void Function1Types::InputValueMapper<Type>::read
(
...
template<class Type>
Function1Types::InputValueMapper<Type>::InputValueMapper
(
...
template<class Type>
void Function1Types::InputValueMapper<Type>::writeEntries
(
    Ostream& os
) const
{
...
template<class Type>
void Function1Types::InputValueMapper<Type>::writeData(Ostream& os) const
{
