...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
Function1Types::TableFile<Type>::TableFile
(
...
template<class Type>
Function1Types::TableFile<Type>::TableFile(const TableFile<Type>& tbl)
:
    TableBase<Type>(tbl),
    fName_(tbl.fName_)
{}
...
template<class Type>
void Function1Types::TableFile<Type>::writeData(Ostream& os) const
{
