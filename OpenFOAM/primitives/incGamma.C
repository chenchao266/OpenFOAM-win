...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
 ...
 namespace Foam{
scalar Math::incGammaRatio_Q(const scalar a, const scalar x)
{
    ...
    if (a < 1)
    {
        ...
        else if ( x < 1.1)
        {
            ...
            {
                sum += pow((-x), (const int)n)/((a + n)*factorial(n));
            }
        ...
        else
        {
            if (floor(2*a) == 2*a)
            {
                ...
                if (floor(a) == a)
                {
                    ...
                    {
                        sum += pow(x, (const int)n)/factorial(n);
                    }
...
scalar Math::incGammaRatio_P(const scalar a, const scalar x)
{
    return 1 - incGammaRatio_Q(a, x);
}


scalar Math::incGamma_Q(const scalar a, const scalar x)
{
    return incGammaRatio_Q(a, x)*tgamma(a);
}


scalar Math::incGamma_P(const scalar a, const scalar x)
{
