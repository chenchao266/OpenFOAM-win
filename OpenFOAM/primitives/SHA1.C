...
inline uint32_t SHA1::swapBytes(uint32_t n)
{
    #ifdef __BYTE_ORDER
...
inline void SHA1::set_uint32(unsigned char *cp, uint32_t v)
{
...
void SHA1::processBlock(const void *data, size_t len)
{
...
void SHA1::calcDigest(SHA1Digest& dig) const
{
