...
StringType stringOps::quotemeta
(
...
SubStrings<StringType> stringOps::split
(
    const StringType& str,
    const char delim,
...
template<class StringType>
SubStrings<StringType> stringOps::splitAny
(
    const StringType& str,
    const std::string& delim
)
...
template<class StringType>
SubStrings<StringType> stringOps::splitFixed
(
    const StringType& str,
...
template<class StringType>
SubStrings<StringType> stringOps::splitSpace
(
    const StringType& str
)
{
