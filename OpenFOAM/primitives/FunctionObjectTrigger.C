...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
void Function1Types::FunctionObjectTrigger<Type>::read
(
...
template<class Type>
Function1Types::FunctionObjectTrigger<Type>::FunctionObjectTrigger
(
...
template<class Type>
void Function1Types::FunctionObjectTrigger<Type>::writeEntries
(
    Ostream& os
) const
{
...
template<class Type>
void Function1Types::FunctionObjectTrigger<Type>::writeData
(
    Ostream& os
) const
{
