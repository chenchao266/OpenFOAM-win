...
tmp<Field<Type>> Matrix<Form, Type>::AmulImpl
(
    const ListType& x
) const
{
...
template<class Form, class Type>
template<class ListType>
tmp<Field<Type>> Matrix<Form, Type>::TmulImpl
(
    const ListType& x
) const
{
...
template<class Form, class Type>
Matrix<Form, Type>::Matrix(const label m, const label n)
:
    mRows_(m),
    nCols_(n),
    v_(nullptr)
...
template<class Form, class Type>
Matrix<Form, Type>::Matrix(const label m, const label n, const zero)
:
    mRows_(m),
    nCols_(n),
    v_(nullptr)
...
template<class Form, class Type>
Matrix<Form, Type>::Matrix(const label m, const label n, const Type& val)
:
    mRows_(m),
    nCols_(n),
    v_(nullptr)
...
template<class Form, class Type>
Matrix<Form, Type>::Matrix(const Matrix<Form, Type>& mat)
:
    mRows_(mat.mRows_),
    nCols_(mat.nCols_),
    v_(nullptr)
...
template<class Form, class Type>
Matrix<Form, Type>::Matrix(Matrix<Form, Type>&& mat)
:
    mRows_(mat.mRows_),
    nCols_(mat.nCols_),
    v_(mat.v_)
...
Matrix<Form, Type>::Matrix(const Matrix<Form2, Type>& mat)
:
    mRows_(mat.m()),
    nCols_(mat.n()),
    v_(nullptr)
...
inline Matrix<Form, Type>::Matrix
(
...
template<class Form, class Type>
List<Type> Matrix<Form, Type>::release()
{
    List<Type> list;
...
template<class Form, class Type>
void Matrix<Form, Type>::swap(Matrix<Form, Type>& mat)
{
    if (this == &mat)
    {
...
template<class Form, class Type>
void Matrix<Form, Type>::transfer(Matrix<Form, Type>& mat)
{
    if (this == &mat)
    {
...
template<class Form, class Type>
void Matrix<Form, Type>::resize(const label m, const label n)
{
...
template<class Form, class Type>
void Matrix<Form, Type>::resize_nocopy(const label mrow, const label ncol)
{
...
template<class Form, class Type>
void Matrix<Form, Type>::round(const scalar tol)
{
    for (Type& val : *this)
    {
        if (mag(val) < tol)
...
template<class Form, class Type>
List<Type> Matrix<Form, Type>::diag() const
{
    const label len = min(mRows_, nCols_);
...
template<class Form, class Type>
void Matrix<Form, Type>::diag(const UList<Type>& list)
{
    const label len = min(mRows_, nCols_);
...
template<class Form, class Type>
Type Matrix<Form, Type>::trace() const
{
    const label len = min(mRows_, nCols_);
...
template<class Form, class Type>
scalar Matrix<Form, Type>::columnNorm
(
...
) const
{
    ...
    return noSqrt ? result : sqrt(result);
}


template<class Form, class Type>
scalar Matrix<Form, Type>::norm(const bool noSqrt) const
{
    scalar result = Zero;
...
template<class Form, class Type>
std::streamsize Matrix<Form, Type>::byteSize() const
{
...
template<class Form, class Type>
void Matrix<Form, Type>::operator=(const Matrix<Form, Type>& mat)
{
    if (this == &mat)
    {
        return;  // Self-assignment is a no-op
...
template<class Form, class Type>
void Matrix<Form, Type>::operator=(Matrix<Form, Type>&& mat)
{
    if (this != &mat)
    {
...
template<class Form, class Type>
template<class MatrixType>
void Matrix<Form, Type>::operator=
(
    const ConstMatrixBlock<MatrixType>& Mb
)
{
...
template<class Form, class Type>
void Matrix<Form, Type>::operator=(const Type& val)
{
    std::fill(begin(), end(), val);
}
...
template<class Form, class Type>
void Matrix<Form, Type>::operator=(const zero)
{
    std::fill(begin(), end(), Zero);
}
...
template<class Form, class Type>
void Matrix<Form, Type>::operator+=(const Matrix<Form, Type>& other)
{
    #ifdef FULLDEBUG
    if (this == &other)
    {
...
template<class Form, class Type>
void Matrix<Form, Type>::operator+=(const Type& s)
{
    for (Type& val : *this)
    {
        val += s;
