...
LUscalarMatrix::LUscalarMatrix() :    comm_(Pstream::worldComm)
{}


LUscalarMatrix::LUscalarMatrix(const scalarSquareMatrix& matrix) :    scalarSquareMatrix(matrix),
...
void LUscalarMatrix::printDiagonalDominance() const
{
    for (label i=0; i<m(); i++)
    {
        scalar sum = 0.0;
...
void LUscalarMatrix::decompose(const scalarSquareMatrix& M)
{
...
void LUscalarMatrix::inv(scalarSquareMatrix& M) const
{
