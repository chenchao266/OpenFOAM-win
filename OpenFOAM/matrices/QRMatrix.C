...
template<class MatrixType>
void QRMatrix<MatrixType>::qrPivot
(
    MatrixType& A
)
{
...
void QRMatrix<MatrixType>::solvex
(
...
template<class MatrixType>
template<template<typename> class ListContainer>
void QRMatrix<MatrixType>::solveImpl
(
    List<cmptType>& x,
...
template<class MatrixType>
void QRMatrix<MatrixType>::decompose
(
    MatrixType& A
)
{
...
template<class MatrixType>
void QRMatrix<MatrixType>::solve
(
    List<cmptType>& x,
...
template<class MatrixType>
tmp<Field<typename MatrixType::cmptType>>
QRMatrix<MatrixType>::solve
(
    const UList<cmptType>& source
) const
{
...
template<class MatrixType>
typename QRMatrix<MatrixType>::SMatrix
QRMatrix<MatrixType>::inv() const
{
    const label m = Q_.m();
...
template<class MatrixType>
RectangularMatrix<typename MatrixType::cmptType>
QRMatrix<MatrixType>::backSubstitution
(
    const SMatrix& A,
    const RMatrix& rhs
)
