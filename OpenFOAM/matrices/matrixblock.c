...
ConstMatrixBlock<MatrixType>::operator Field<typename MatrixType::cmptType>() const
{
    if (nCols_ != 1)
    {
...
template<class MatrixType>
MatrixBlock<MatrixType>::operator Field<typename MatrixType::cmptType>() const
{
    if (nCols_ != 1)
    {
        FatalErrorInFunction
...
template<class MatrixType>
label ConstMatrixBlock<MatrixType>::disallow
(
    const char* what
) const
{
...
template<class MatrixType>
label MatrixBlock<MatrixType>::disallow
(
    const char* what
) const
{
...
template<class MatrixType> void ConstMatrixBlock<MatrixType>::checkIndex
(
    const label i,
    const label j
) const
...
template<class MatrixType> void MatrixBlock<MatrixType>::checkIndex
(
    const label i,
    const label j
) const
...
template<class MatrixType>
template<class Form>
void MatrixBlock<MatrixType>::operator=
(
...
template
<
    template<class, direction, direction> class MSBlock,
    class SubTensor,
    direction BRowStart,
    direction BColStart
>
...
template
<
    template<class, direction> class VSBlock,
    class SubVector,
    direction BStart
>
void MatrixBlock<MatrixType>::operator=
...
template<class MatrixType>
void MatrixBlock<MatrixType>::operator=(const Field<cmptType>& f)
{
