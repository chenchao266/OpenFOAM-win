...
namespace Foam {
    ...
    void Matrix<Form, Type>::allocate()
    {
        if (mRows_ && nCols_)
        {
            v_ = new Type[size()];
    ...
    template<class Form, class Type>
    Matrix<Form, Type>::Matrix(const label m, const label n, const Type& s)
        :
        mRows_(m),
        nCols_(n),
        v_(nullptr)
    ...
    template<class Form, class Type>
    Matrix<Form, Type>::Matrix(const Matrix<Form, Type>& M)
        :
        mRows_(M.mRows_),
        nCols_(M.nCols_),
        v_(nullptr)
    ...
    Matrix<Form, Type>::Matrix(const Matrix<Form2, Type>& M)
        :
        mRows_(M.m()),
        nCols_(M.n()),
        v_(nullptr)
    ...
    template<class Form, class Type>
    void Matrix<Form, Type>::transfer(Matrix<Form, Type>& M)
    {
        clear();
    ...
    template<class Form, class Type>
    void Matrix<Form, Type>::setSize(const label m, const label n)
    {
    ...
    template<class Form, class Type>
    void Matrix<Form, Type>::operator=(const Matrix<Form, Type>& M)
    {
        if (this == &M)
        {
            FatalErrorInFunction
    ...
    template<class Form, class Type>
    Form operator+(const Matrix<Form, Type>& A, const Matrix<Form, Type>& B)
    {
        if (A.m() != B.m())
        {
            FatalErrorInFunction
    ...
    template<class Form, class Type>
    Form operator*(const scalar s, const Matrix<Form, Type>& M)
    {
        Form sM(M.m(), M.n());
    ...
    template<class Form, class Type>
    Form operator*(const Matrix<Form, Type>& M, const scalar s)
    {
        Form sM(M.m(), M.n());
