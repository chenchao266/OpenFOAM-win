...
#include "MatrixBlock.T.H"

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
namespace Foam {

    template<class MatrixType>
    ConstMatrixBlock<MatrixType>::operator typename Field<ConstMatrixBlock::cmptType>() const
    {
        if (nCols_ != 1)
        {
        ...
        Field<ConstMatrixBlock::cmptType> f(mRows_);
    ...
    template<class MatrixType>
    MatrixBlock<MatrixType>::operator typename Field<MatrixBlock::cmptType>() const
    {
        if (nCols_ != 1)
        {
            FatalErrorInFunction
        ...
        Field<MatrixBlock::cmptType> f(mRows_);
    ...
    template<class MatrixType>
    void MatrixBlock<MatrixType>::operator=(const Field<MatrixBlock::cmptType>& f)
    {
