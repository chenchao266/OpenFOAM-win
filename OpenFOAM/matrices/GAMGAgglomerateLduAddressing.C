...
void GAMGAgglomeration::procAgglomerateLduAddressing
(
...
void GAMGAgglomeration::procAgglomerateRestrictAddressing
(
    const label comm,
    const labelList& procIDs,
    const label levelIndex
...
void GAMGAgglomeration::combineLevels(const label curLevel)
{
...
void GAMGAgglomeration::calculateRegionMaster
(
    const label comm,
    const labelList& procAgglomMap,
