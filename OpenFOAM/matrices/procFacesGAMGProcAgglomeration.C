...
autoPtr<lduPrimitiveMesh>
procFacesGAMGProcAgglomeration::singleCellMesh
(
...
tmp<labelField>
procFacesGAMGProcAgglomeration::processorAgglomeration
(
    const lduMesh& mesh
) const
{
...
bool procFacesGAMGProcAgglomeration::doProcessorAgglomeration
(
    const lduMesh& mesh
) const
{
...
bool procFacesGAMGProcAgglomeration::agglomerate()
{
    if (debug)
    {
