...
void GAMGInterface::combine(const GAMGInterface& coarseGi)
{
...
tmp<labelField> GAMGInterface::interfaceInternalField
(
...
tmp<scalarField> GAMGInterface::agglomerateCoeffs
(
...
void GAMGInterface::write(Ostream& os) const
{
