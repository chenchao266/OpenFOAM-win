...
template<class Type, class DType, class LUType>
typename SolverPerformance<Type>
PCICG<Type, DType, LUType>::solve(Field<Type>& psi) const
{
    ...
    Type wArA = solverPerf.great_*pTraits<Type>::one_;
    Type wArAold = wArA;
    ...
    solverPerf.nIterations() =
        pTraits<typename pTraits<Type>::labelType>::one_*nIter;
