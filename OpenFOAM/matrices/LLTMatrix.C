...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
LLTMatrix<Type>::LLTMatrix()
{}


template<class Type>
LLTMatrix<Type>::LLTMatrix(const SquareMatrix<Type>& mat)
{
    decompose(mat);
}
...
template<class Type>
void LLTMatrix<Type>::decompose(const SquareMatrix<Type>& mat)
{
...
template<class Type>
tmp<Field<Type>> LLTMatrix<Type>::solve
(
    const UList<Type>& source
) const
{
