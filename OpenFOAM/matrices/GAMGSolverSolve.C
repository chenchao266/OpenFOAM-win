...
solverPerformance GAMGSolver::solve
(
    scalarField& psi,
...
dictionary GAMGSolver::PCGsolverDict
(
    const scalar tol,
    const scalar relTol
) const
...
dictionary GAMGSolver::PBiCGStabSolverDict
(
    const scalar tol,
    const scalar relTol
) const
...
void GAMGSolver::solveCoarsestLevel
(
