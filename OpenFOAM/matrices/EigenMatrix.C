...
void EigenMatrix<cmptType>::tridiagonaliseSymmMatrix()
{
...
template<class cmptType>
void EigenMatrix<cmptType>::symmTridiagonalQL()
{
...
template<class cmptType>
void EigenMatrix<cmptType>::Hessenberg()
{
...
template<class cmptType>
void EigenMatrix<cmptType>::realSchur()
{
    // Initialize
    label nn = n_;
    label n = nn - 1;
...
template<class cmptType>
EigenMatrix<cmptType>::EigenMatrix(const SquareMatrix<cmptType>& A)
:
    n_(A.n()),
    EValsRe_(n_, Zero),
    EValsIm_(n_, Zero),
...
template<class cmptType>
EigenMatrix<cmptType>::EigenMatrix
(
...
template<class cmptType>
const SquareMatrix<complex>
EigenMatrix<cmptType>::complexEVecs() const
{
