...
namespace Foam {
    ...
    LduMatrix<Type, DType, LUType>::LduMatrix(const lduMesh& mesh)
        :
        lduMesh_(mesh),
        diagPtr_(nullptr),
        upperPtr_(nullptr),
    ...
    template<class Type, class DType, class LUType>
    LduMatrix<Type, DType, LUType>::LduMatrix(const LduMatrix& A)
        :
        lduMesh_(A.lduMesh_),
        diagPtr_(nullptr),
        upperPtr_(nullptr),
    ...
    template<class Type, class DType, class LUType>
    LduMatrix<Type, DType, LUType>::LduMatrix(LduMatrix& A, bool reuse)
        :
        lduMesh_(A.lduMesh_),
        diagPtr_(nullptr),
        upperPtr_(nullptr),
    ...
    template<class Type, class DType, class LUType>
    LduMatrix<Type, DType, LUType>::LduMatrix
    (
        const lduMesh& mesh,
        Istream& is
    )
    ...
    template<class Type, class DType, class LUType>
    Field<DType>& LduMatrix<Type, DType, LUType>::diag()
    {
        if (!diagPtr_)
        {
    ...
    template<class Type, class DType, class LUType>
    Field<LUType>& LduMatrix<Type, DType, LUType>::upper()
    {
        if (!upperPtr_)
        {
            if (lowerPtr_)
    ...
    template<class Type, class DType, class LUType>
    Field<LUType>& LduMatrix<Type, DType, LUType>::lower()
    {
        if (!lowerPtr_)
        {
            if (upperPtr_)
    ...
    template<class Type, class DType, class LUType>
    Field<Type>& LduMatrix<Type, DType, LUType>::source()
    {
        if (!sourcePtr_)
        {
...
#include "LduMatrixOperations.T.C"
#include "LduMatrixATmul.T.C"
#include "LduMatrixUpdateMatrixInterfaces.T.C"
#include "LduMatrixPreconditioner.T.C"
#include "LduMatrixSmoother.T.C"
#include "LduMatrixSolver.T.C"
