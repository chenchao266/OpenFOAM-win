...
namespace Foam
{
    void GAMGAgglomeration::compactLevels(const label nCreatedLevels)
    {
    ...
    bool GAMGAgglomeration::continueAgglomerating
    (
    ...
    const GAMGAgglomeration& GAMGAgglomeration::New
    (
        const lduMesh& mesh,
        const dictionary& controlDict
    )
    ...
    autoPtr<GAMGAgglomeration> GAMGAgglomeration::New
    (
        const lduMesh& mesh,
    ...
    const lduMesh& GAMGAgglomeration::meshLevel
    (
        const label i
    ) const
    {
    ...
    bool GAMGAgglomeration::hasMeshLevel(const label i) const
    {
        if (i == 0)
        {
            return true;
    ...
    const lduInterfacePtrsList& GAMGAgglomeration::interfaceLevel
    (
        const label i
    ) const
    {
    ...
    void GAMGAgglomeration::clearLevel(const label i)
    {
        if (hasMeshLevel(i))
        {
    ...
    const labelList& GAMGAgglomeration::procAgglomMap
    (
        const label leveli
    ) const
    {
    ...
    const labelList& GAMGAgglomeration::agglomProcIDs
    (
        const label leveli
    ) const
    {
    ...
    bool GAMGAgglomeration::hasProcMesh(const label leveli) const
    {
        return procCommunicator_[leveli] != -1;
    }


    label GAMGAgglomeration::procCommunicator(const label leveli) const
    {
        return procCommunicator_[leveli];
    }


    const labelList& GAMGAgglomeration::cellOffsets
    (
        const label leveli
    ) const
    {
    ...
    const labelListList& GAMGAgglomeration::faceMap
    (
        const label leveli
    ) const
    {
    ...
    const labelListList& GAMGAgglomeration::boundaryMap
    (
        const label leveli
    ) const
    {
    ...
    const labelListListList& GAMGAgglomeration::boundaryFaceMap
    (
        const label leveli
    ) const
    {
    ...
    bool GAMGAgglomeration::checkRestriction
    (
