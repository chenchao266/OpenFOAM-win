...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
schemesLookup::lookupDetail::lookupDetail
(
    const word& dictName,
...
void schemesLookup::lookupDetail::clear()
{
    dict_.clear();
    default_.clear();
}
...
ITstream& schemesLookup::lookupDetail::fallback() const
{
...
ITstream& schemesLookup::lookupDetail::lookup
(
    const word& name
) const
{
...
void schemesLookup::lookupDetail::populate
(
...
void schemesLookup::lookupDetail::writeEntry(Ostream& os) const
{
    dict_.writeEntry(os);
}


void schemesLookup::lookupDetail::writeEntryOptional(Ostream& os) const
{
    if (!dict_.empty())
    {
        dict_.writeEntry(os);
