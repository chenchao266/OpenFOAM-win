...
void functionObjects::writeObjectsBase::resetWriteObjectName
(
    const wordRe& name
)
{
...
void functionObjects::writeObjectsBase::resetWriteObjectNames
(
...
wordList functionObjects::writeObjectsBase::objectNames()
{
...
void functionObjects::writeObjectsBase::writeObject
(
...
functionObjects::writeObjectsBase::writeObjectsBase
(
...
const wordReList&
functionObjects::writeObjectsBase::writeObjectNames() const
{
    return writeObjectNames_;
}


bool functionObjects::writeObjectsBase::read(const dictionary& dict)
{
...
bool functionObjects::writeObjectsBase::write()
{
