...
bool functionEntries::codeStream::doingMasterOnlyReading
(
    const dictionary& dict
)
{
...
functionEntries::codeStream::streamingFunctionType
functionEntries::codeStream::getFunction
(
...
bool functionEntries::codeStream::execute
(
    const dictionary& parentDict,
