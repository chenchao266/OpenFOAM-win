...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
Type functionObjects::properties::getObjectProperty
(
...
template<class Type>
bool functionObjects::properties::getObjectProperty
(
    const word& objectName,
    const word& entryName,
    Type& value
...
template<class Type>
void functionObjects::properties::setObjectProperty
(
    const word& objectName,
    const word& entryName,
    const Type& value
...
template<class Type>
void functionObjects::properties::setObjectResult
(
    const word& objectName,
    const word& entryName,
    const Type& value
...
template<class Type>
Type functionObjects::properties::getObjectResult
(
    const word& objectName,
    const word& entryName,
    const Type& defaultValue
...
template<class Type>
bool functionObjects::properties::getObjectResult
(
    const word& objectName,
    const word& entryName,
    Type& value
