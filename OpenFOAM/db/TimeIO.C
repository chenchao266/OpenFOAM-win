...
void Time::readDict()
{
    ...
    )
    {
        ...
        fileHandler(std::move(newHandler));
    ...
    )
    {
        ...
        dictionary dict(dimensionSystems());
...
Ostream& Time::printExecutionTime(OSstream& os) const
{
