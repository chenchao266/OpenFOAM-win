...
// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //
 ...
 namespace Foam{
bool TimePaths::detectProcessorCase()
{
    if (processorCase_)
    {
...
instantList TimePaths::findTimes
(
...
instantList TimePaths::times() const
{
    return findTimes(path(), constant());
}


label TimePaths::findClosestTimeIndex
(
...
instant TimePaths::findClosestTime(const scalar t) const
{
