...
class CompactIOField :    public regIOobject,
    public Field<Ty>
{
...
public:
    ...
    // Constructors
        ...
        CompactIOField(const IOobject&, const Field<Ty>&);

        //- Construct by transferring the Field contents
        CompactIOField(const IOobject&, const Xfer<Field<Ty>>&);
    ...
    // Member operators
        ...
        void operator=(const CompactIOField<Ty, BaseType>&);

        void operator=(const Field<Ty>&);
};
