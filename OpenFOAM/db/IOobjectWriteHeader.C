...
\*---------------------------------------------------------------------------*/
 ...
 namespace Foam{
Ostream&
IOobject::writeBanner(Ostream& os, const bool noSyntaxHint)
{
    ...
    if (!*paddedVersion)
    {
        ...
        const std::string apiValue(std::to_string(foamVersion::api));
...
Ostream& IOobject::writeDivider(Ostream& os)
{
    os  <<
        "// * * * * * * * * * * * * * * * * * "
        "* * * * * * * * * * * * * * * * * * * * //\n";
...
Ostream& IOobject::writeEndDivider(Ostream& os)
{
    os  << "\n\n"
        "// *****************************************"
        "******************************** //\n";
...
void IOobject::writeHeaderContent
(
    Ostream& os,
    const IOobject& io,
