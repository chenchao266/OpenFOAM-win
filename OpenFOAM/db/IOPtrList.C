...
template<class T>
IOPtrList<T>::IOPtrList(const IOobject& io, const label len)
:
    regIOobject(io),
    PtrList<T>(len)
{
...
template<class T>
IOPtrList<T>::IOPtrList(const IOobject& io, const PtrList<T>& content)
:
    regIOobject(io)
{
    if
...
template<class T>
IOPtrList<T>::IOPtrList(const IOobject& io, PtrList<T>&& content)
:
    regIOobject(io)
{
