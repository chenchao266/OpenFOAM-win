...
namespace Foam {
    ...
    void CompactIOList<T, BaseType>::readFromStream()
    {
    ...
    template<class T, class BaseType>
    bool CompactIOList<T, BaseType>::overflows() const
    {
        label size = 0;
        forAll(*this, i)
        {
    ...
    template<class T, class BaseType>
    CompactIOList<T, BaseType>::CompactIOList
    (
        const IOobject& io,
        const label size
    )
    ...
    template<class T, class BaseType>
    bool CompactIOList<T, BaseType>::writeObject
    (
    ...
    template<class T, class BaseType>
    bool CompactIOList<T, BaseType>::writeData(Ostream& os) const
    {
        return (os << *this).good();
    }
    ...
    template<class T, class BaseType>
    void CompactIOList<T, BaseType>::operator=
        (
    ...
    template<class T, class BaseType>
    void CompactIOList<T, BaseType>::operator=(const List<T>& rhs)
    {
        List<T>::operator=(rhs);
    }
    ...
    Ostream& operator<<
        (
            Ostream& os,
            const CompactIOList<T, BaseType>& L
            )
    {
