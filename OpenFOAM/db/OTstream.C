...
// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
bool OTstream::write(const token& tok)
{
    if (tok.good())
    {
        append(tok);
...
Ostream& OTstream::write(const char c)
{
...
Ostream& OTstream::write(const char* str)
{
...
Ostream& OTstream::write(const word& str)
{
...
Ostream& OTstream::write(const string& str)
{
...
Ostream& OTstream::write(const int32_t val)
{
...
Ostream& OTstream::write(const int64_t val)
{
    append(token(label(val))); // tokenType::LABEL
...
Ostream& OTstream::write(const floatScalar val)
{
...
Ostream& OTstream::write(const doubleScalar val)
{
...
Ostream& OTstream::write(const char* data, std::streamsize count)
{
...
bool OTstream::beginRawWrite(std::streamsize count)
{
    if (format() != IOstreamOption::BINARY)
    {
        FatalErrorInFunction
...
void OTstream::print(Ostream& os) const
{
