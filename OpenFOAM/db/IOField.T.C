...
namespace Foam {
    ...
    template<class Type>
    IOField<Type>::IOField(const IOobject& io, const Field<Type>& f)
        :
        regIOobject(io)
    {
        // Check for MUST_READ_IF_MODIFIED
    ...
    template<class Type>
    IOField<Type>::IOField(const IOobject& io, const Xfer<Field<Type>>& f)
        :
        regIOobject(io)
    {
        // Check for MUST_READ_IF_MODIFIED
    ...
    template<class Type>
    void IOField<Type>::operator=(const Field<Type>& rhs)
    {
        Field<Type>::operator=(rhs);
    }
