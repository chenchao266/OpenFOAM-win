...
// * * * * * * * * * * * * * Static Member Data  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
const IOstreamOption::versionNumber IOstreamOption::currentVersion;

const Enum
<
    IOstreamOption::streamFormat
>
IOstreamOption::formatNames
({
...
IOstreamOption::compressionEnum
(
    const word& compName,
...
IOstreamOption::versionNumber::versionNumber(const std::string& verNum)
:
    versionNumber(readFloat(verNum))
{}


IOstreamOption::versionNumber::versionNumber(const token& tok)
:
    versionNumber()
{
    if (tok.isStringType())
...
IOstreamOption::versionNumber::versionNumber
(
    const word& key,
    const dictionary& dict
)
