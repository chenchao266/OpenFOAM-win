...
namespace Foam
{
const entry* dictionary::lookupScopedSubEntryPtr
(
    const word& keyword,
    bool recursive,
    bool patternMatch
...
bool dictionary::findInPatterns
(
...
dictionary::dictionary() :    parent_(dictionary::null)
{}


dictionary::dictionary(const fileName& name) :    dictionaryName(name),
...
const entry* dictionary::lookupEntryPtr
(
    const word& keyword,
    bool recursive,
    bool patternMatch
...
entry* dictionary::lookupEntryPtr
(
    const word& keyword,
    bool recursive,
    bool patternMatch
...
const entry* dictionary::lookupScopedEntryPtr
(
    const word& keyword,
    bool recursive,
    bool patternMatch
...
bool dictionary::substituteScopedKeyword(const word& keyword)
{
...
const dictionary* dictionary::subDictPtr(const word& keyword) const
{
    const entry* entryPtr = lookupEntryPtr(keyword, false, true);
...
dictionary* dictionary::subDictPtr(const word& keyword)
{
...
dictionary& dictionary::subDict(const word& keyword)
{
    entry* entryPtr = lookupEntryPtr(keyword, false, true);
...
bool dictionary::add(entry* entryPtr, bool mergeEntry)
{
...
void dictionary::add(const entry& e, bool mergeEntry)
{
    add(e.clone(*this).ptr(), mergeEntry);
}


void dictionary::add(const keyType& k, const word& w, bool overwrite)
{
...
void dictionary::add(const keyType& k, const label l, bool overwrite)
{
    add(new primitiveEntry(k, token(l)), overwrite);
}


void dictionary::add(const keyType& k, const scalar s, bool overwrite)
{
    add(new primitiveEntry(k, token(s)), overwrite);
}
...
void dictionary::set(entry* entryPtr)
{
...
void dictionary::set(const entry& e)
{
    set(e.clone(*this).ptr());
}


void dictionary::set(const keyType& k, const dictionary& d)
{
...
Xfer<dictionary> dictionary::xfer()
{
