...
IOobjectList::IOobjectList(const label nIoObjects) :    HashPtrTable<IOobject>(nIoObjects)
{}
...
IOobjectList::IOobjectList(const IOobjectList& ioOL) :    HashPtrTable<IOobject>(ioOL)
{}
...
IOobjectList IOobjectList::lookup(const wordRe& name) const
{
...
IOobjectList IOobjectList::lookup(const wordReList& patterns) const
{
...
wordList IOobjectList::sortedNames(const word& ClassName) const
{
