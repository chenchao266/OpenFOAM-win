...
namespace Foam {
    ...
    template<class Type>
    wordList objectRegistry::names(const wordRe& name) const
    {
        wordList objectNames(size());
    ...
    template<class Type>
    wordList objectRegistry::names(const wordReList& patterns) const
    {
    ...
    template<class Type>
    Type& objectRegistry::lookupObjectRef(const word& name) const
    {
