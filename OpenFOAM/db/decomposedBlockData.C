...
bool decomposedBlockData::readMasterHeader(IOobject& io, Istream& is)
{
    if (debug)
    {
...
void decomposedBlockData::writeHeader
(
    Ostream& os,
...
autoPtr<ISstream> decomposedBlockData::readBlock
(
    const label blocki,
    Istream& is,
    IOobject& headerIO
...
bool decomposedBlockData::readBlocks
(
    const label comm,
...
autoPtr<ISstream> decomposedBlockData::readBlocks
(
    const label comm,
...
void decomposedBlockData::gather
(
    const label comm,
    const label data,
    labelList& datas
...
void decomposedBlockData::gatherSlaveData
(
    const label comm,
...
bool decomposedBlockData::writeBlocks
(
    const label comm,
...
bool decomposedBlockData::writeData(Ostream& os) const
{
...
bool decomposedBlockData::writeObject
(
    IOstream::streamFormat fmt,
...
label decomposedBlockData::numBlocks(const fileName& fName)
{
    label nBlocks = 0;
