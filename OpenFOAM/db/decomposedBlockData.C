...
namespace Foam
{
    ...
    bool decomposedBlockData::isCollatedType
    (
    ...
    bool decomposedBlockData::readBlockEntry
    (
        Istream& is,
        List<char>& charData
    )
    ...
    std::streamoff decomposedBlockData::writeBlockEntry
    (
        OSstream& os,
        const label blocki,
    ...
    label decomposedBlockData::calcNumProcs
    (
        const label comm,
