...
// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //
 ...
 namespace Foam{
void functionEntries::ifeqEntry::readToken(token& t, Istream& is)
{
...
token functionEntries::ifeqEntry::expandToken
(
...
bool functionEntries::ifeqEntry::equalToken
(
    const token& t1,
    const token& t2
)
...
void functionEntries::ifeqEntry::skipUntil
(
...
bool functionEntries::ifeqEntry::evaluate
(
    const bool doIf,
    DynamicList<filePos>& stack,
...
bool functionEntries::ifeqEntry::execute
(
    const bool doIf,
    DynamicList<filePos>& stack,
    dictionary& parentDict,
