...
template<class Type>
Type interpolationTable<Type>::rateOfChange(scalar lookupValue) const
{
    const List<value_type>& list = *this;
...
template<class Type>
Type interpolationTable<Type>::interpolateValue
(
...
template<class Type>
tmp<Field<Type>>
interpolationTable<Type>::interpolateValues
(
...
template<class Type>
void interpolationTable<Type>::operator=
(
...
interpolationTable<Type>::operator[](label idx) const
{
    const List<value_type>& list = *this;
    const label n = list.size();
...
template<class Type>
Type interpolationTable<Type>::operator()(scalar lookupValue) const
{
    return interpolateValue(*this, lookupValue, bounding_);
}
