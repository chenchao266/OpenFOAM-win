...
namespace Foam {
    template<class Type>
    void interpolationTable<Type>::readTable()
    {
    ...
    template<class Type>
    interpolationTable<Type>::interpolationTable()
        :
    ...
    template<class Type>
    interpolationTable<Type>::interpolationTable(const fileName& fName)
        :
        List<Tuple2<scalar, Type>>(),
        boundsHandling_(interpolationTable::WARN),
        fileName_(fName),
    ...
    template<class Type>
    interpolationTable<Type>::interpolationTable(const dictionary& dict)
        :
        List<Tuple2<scalar, Type>>(),
    ...
    template<class Type>
    word interpolationTable<Type>::boundsHandlingToWord
    (
    ...
    template<class Type>
    typename interpolationTable<Type>::boundsHandling
        interpolationTable<Type>::wordToBoundsHandling
        (
            const word& bound
        ) const
    {
    ...
    template<class Type>
    typename interpolationTable<Type>::boundsHandling
        interpolationTable<Type>::outOfBounds
        (
            const boundsHandling& bound
        )
    {
    ...
    template<class Type>
    void interpolationTable<Type>::check() const
    {
        label n = this->size();
    ...
    template<class Type>
    void interpolationTable<Type>::write(Ostream& os) const
    {
    ...
    template<class Type>
    Type interpolationTable<Type>::rateOfChange(const scalar value) const
    {
        label n = this->size();
    ...
    const Tuple2<scalar, Type>&
        interpolationTable<Type>::operator[](const label i) const
    {
        label ii = i;
        label n = this->size();
    ...
    template<class Type>
    Type interpolationTable<Type>::operator()(const scalar value) const
    {
        label n = this->size();
