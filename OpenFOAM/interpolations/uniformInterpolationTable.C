...
// * * * * * * * * * * * *  Private Member Functions * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
void uniformInterpolationTable<Type>::checkTable() const
{
    if (size() < 2)
    {
...
template<class Type>
uniformInterpolationTable<Type>::uniformInterpolationTable
(
    const IOobject& io,
    bool readFields
)
...
template<class Type>
Type uniformInterpolationTable<Type>::interpolate(scalar x) const
{
    if (bound_)
    {
...
template<class Type>
Type uniformInterpolationTable<Type>::interpolateLog10
(
    scalar x
) const
{
...
template<class Type>
void uniformInterpolationTable<Type>::write() const
{
