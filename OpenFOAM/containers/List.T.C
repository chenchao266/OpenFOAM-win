...
namespace Foam {
    ...
    template<class T>
    List<T>::List(const label s, const zero)
        :
        UList<T>(nullptr, s)
    {
        if (this->size_ < 0)
    ...
    template<class T>
    List<T>::List(const Xfer<List<T>>& lst)
    {
        transfer(lst());
    }
    ...
    template<class T>
    List<T>::List(const UList<T>& a, const labelUList& map)
        :
    ...
    List<T>::List(const FixedList<T, Size>& lst)
        :
    ...
    template<class T>
    List<T>::List(const PtrList<T>& lst)
        :
    ...
    template<class T>
    List<T>::List(const SLList<T>& lst)
        :
    ...
    template<class T>
    List<T>::List(const BiIndirectList<T>& lst)
        :
        UList<T>(nullptr, lst.size())
    {
        allocCopyList(lst);
    ...
    template<class T>
    void List<T>::transfer(SortableList<T>& a)
    {
    ...
    template<class T>
    void List<T>::operator=(const SLList<T>& lst)
    {
        reAlloc(lst.size());
    ...
    template<class T>
    void List<T>::operator=(const BiIndirectList<T>& lst)
    {
        reAlloc(lst.size());
        copyList(lst);
    }
    ...
    template<class T>
    void List<T>::operator=(std::initializer_list<T> lst)
    {
        reAlloc(lst.size());
