...
CompactListList<T, Container>::CompactListList(const List<Container>& ll)
:
    size_(ll.size()),
    offsets_(ll.size()+1)
{
...
template<class T, class Container>
CompactListList<T, Container>::CompactListList
(
...
template<class T, class Container>
void CompactListList<T, Container>::setSize(const label mRows)
{
    if (mRows == 0)
    {
        clear();
...
template<class T, class Container>
void CompactListList<T, Container>::setSize
(
    const label mRows,
    const label nData
)
...
template<class T, class Container>
void CompactListList<T, Container>::setSize(const labelUList& rowSizes)
{
    size_ = rowSizes.size();
...
template<class T, class Container>
labelList CompactListList<T, Container>::sizes() const
{
...
template<class T, class Container>
void CompactListList<T, Container>::clear()
{
    size_ = 0;
    offsets_.clear();
    m_.clear();
...
template<class T, class Container>
void CompactListList<T, Container>::swap
(
...
template<class T, class Container>
void CompactListList<T, Container>::transfer
(
...
template<class T, class Container>
List<Container> CompactListList<T, Container>::operator()()
const
{
