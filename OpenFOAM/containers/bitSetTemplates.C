...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<unsigned N>
bitSet::bitSet(const label n, const FixedList<label, N>& locations)
:
    bitSet(n)
{
...
template<unsigned N>
bitSet::bitSet(const FixedList<label, N>& locations)
:
    bitSet()
{
...
label bitSet::setMany(InputIter first, InputIter last)
{
...
template<class InputIter>
label bitSet::unset(InputIter first, InputIter last)
{
    label changed = 0;
...
template<unsigned N>
label bitSet::set(const FixedList<label, N>& locations)
{
...
template<unsigned N>
label bitSet::unset(const FixedList<label, N>& locations)
{
