...
template<class T, class Key, class Hash>
HashTable<T, Key, Hash>::HashTable(HashTable<T, Key, Hash>&& rhs)
:
    HashTableCore(),
    size_(rhs.size_),
...
template<class T, class Key, class Hash>
List<Key> HashTable<T, Key, Hash>::sortedToc() const
{
...
List<Key> HashTable<T, Key, Hash>::sortedToc
(
    const Compare& comp
) const
{
...
List<Key> HashTable<T, Key, Hash>::tocKeys
(
...
template<class T, class Key, class Hash>
template<class UnaryPredicate>
List<Key> HashTable<T, Key, Hash>::tocValues
(
    const UnaryPredicate& pred,
    const bool invert
) const
...
List<Key> HashTable<T, Key, Hash>::tocEntries
(
...
template<class T, class Key, class Hash>
template<class UnaryPredicate>
label HashTable<T, Key, Hash>::countKeys
(
    const UnaryPredicate& pred,
    const bool invert
) const
...
template<class T, class Key, class Hash>
template<class UnaryPredicate>
label HashTable<T, Key, Hash>::countValues
(
    const UnaryPredicate& pred,
    const bool invert
) const
...
template<class T, class Key, class Hash>
template<class BinaryPredicate>
label HashTable<T, Key, Hash>::countEntries
(
    const BinaryPredicate& pred,
    const bool invert
) const
...
template<class T, class Key, class Hash>
template<class... Args>
bool HashTable<T, Key, Hash>::setEntry
(
...
template<class T, class Key, class Hash>
bool HashTable<T, Key, Hash>::erase(const iterator& iter)
{
...
inline label HashTable<T, Key, Hash>::erase
(
    InputIter first,
    InputIter last
)
...
label HashTable<T, Key, Hash>::erase
(
...
template<class T, class Key, class Hash>
template<class AnyType, class AnyHash>
label HashTable<T, Key, Hash>::retain
(
    const HashTable<AnyType, Key, AnyHash>& other
)
{
...
template<class T, class Key, class Hash>
void HashTable<T, Key, Hash>::resize(const label sz)
{
...
template<class T, class Key, class Hash>
void HashTable<T, Key, Hash>::swap(HashTable<T, Key, Hash>& rhs)
{
    if (this == &rhs)
    {
...
template<class T, class Key, class Hash>
void HashTable<T, Key, Hash>::transfer(HashTable<T, Key, Hash>& rhs)
{
    if (this == &rhs)
    {
...
template<class T, class Key, class Hash>
template<class UnaryPredicate>
label HashTable<T, Key, Hash>::filterKeys
(
    const UnaryPredicate& pred,
    const bool pruning
)
...
template<class T, class Key, class Hash>
template<class UnaryPredicate>
label HashTable<T, Key, Hash>::filterValues
(
    const UnaryPredicate& pred,
    const bool pruning
)
...
template<class T, class Key, class Hash>
template<class BinaryPredicate>
label HashTable<T, Key, Hash>::filterEntries
(
    const BinaryPredicate& pred,
    const bool pruning
)
...
template<class T, class Key, class Hash>
void HashTable<T, Key, Hash>::operator=
(
...
template<class T, class Key, class Hash>
bool HashTable<T, Key, Hash>::operator==
(
    const HashTable<T, Key, Hash>& rhs
) const
{
...
template<class T, class Key, class Hash>
HashTable<T, Key, Hash>& HashTable<T, Key, Hash>::operator+=
(
    const HashTable<T, Key, Hash>& rhs
)
{
