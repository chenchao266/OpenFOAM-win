...
std::streamsize FixedList<T, N>::byteSize()
{
...
template<class T, unsigned N>
label FixedList<T, N>::find(const T& val, label pos) const
{
    if (pos >= 0)
    {
...
template<class T, unsigned N>
label FixedList<T, N>::rfind(const T& val, label pos) const
{
...
template<class T, unsigned N>
void FixedList<T, N>::moveFirst(const label i)
{
    checkIndex(i);
...
template<class T, unsigned N>
void FixedList<T, N>::moveLast(const label i)
{
    checkIndex(i);
...
template<class T, unsigned N>
void FixedList<T, N>::swapFirst(const label i)
{
    checkIndex(i);
...
template<class T, unsigned N>
void FixedList<T, N>::swapLast(const label i)
{
    checkIndex(i);
...
template<class T, unsigned N>
bool FixedList<T, N>::operator==(const FixedList<T, N>& list) const
{
