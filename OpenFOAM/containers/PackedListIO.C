...
void PackedList<Width>::writeEntry(Ostream& os) const
{
    os  << *this;
}
...
template<unsigned Width>
Ostream& PackedList<Width>::printBits
(
    Ostream& os,
    bool debugOutput
) const
...
template<unsigned Width>
Istream& PackedList<Width>::readList(Istream& is)
{
...
template<unsigned Width>
Ostream& PackedList<Width>::writeList
(
    Ostream& os,
...
template<unsigned Width>
void PackedList<Width>::writeEntry
(
    const word& keyword,
    Ostream& os
) const
