...
namespace Foam {
    ...
    unsigned int PackedList<nBits>::count() const
    {
        unsigned int c = 0;
    ...
    template<unsigned nBits>
    Xfer<labelList> PackedList<nBits>::values() const
    {
    ...
    template<unsigned nBits>
    Ostream& PackedList<nBits>::iteratorBase::printInfo
    (
        Ostream& os
    ) const
    {
    ...
    template<unsigned nBits>
    Ostream& PackedList<nBits>::printBits
    (
        Ostream& os,
    ...
    template<unsigned nBits>
    Ostream& PackedList<nBits>::printInfo
    (
        Ostream& os,
        const bool fullOutput
    ) const
    ...
    template<unsigned nBits>
    Istream& PackedList<nBits>::read(Istream& is)
    {
    ...
    template<unsigned nBits>
    Ostream& PackedList<nBits>::write
    (
        Ostream& os,
    ...
    template<unsigned nBits>
    void PackedList<nBits>::writeEntry(Ostream& os) const
    {
        os << *this;
    }
    ...
    template<unsigned nBits>
    void PackedList<nBits>::writeEntry
    (
        const word& keyword,
        Ostream& os
    ) const
    ...
    template<unsigned nBits>
    void PackedList<nBits>::operator=(const PackedList<nBits>& lst)
    {
    ...
    template<unsigned nBits>
    void PackedList<nBits>::operator=(const labelUList& lst)
    {
    ...
    template<unsigned nBits>
    void PackedList<nBits>::operator=(const UIndirectList<label>& lst)
    {
        setCapacity(lst.size());
        size_ = lst.size();
