...
bitSet& bitSet::minusEq(const bitSet& other)
{
    if (&other == this)
    {
...
bitSet& bitSet::andEq(const bitSet& other)
{
    if (&other == this)
    {
        // Self '&=' : no-op
...
bitSet& bitSet::orEq(const bitSet& other, const bool strict)
{
    if (&other == this)
    {
        // Self '|=' : no-op
...
bitSet& bitSet::xorEq(const bitSet& other, const bool strict)
{
    if (&other == this)
    {
        // Self '^=' : results in clearing all bits
...
bitSet::bitSet(const bitSet& bitset, const labelUList& addr)
:
    bitSet(addr.size())
{
...
bitSet::bitSet(const bitSet& bitset, const labelRange& range)
:
    bitSet(range.size())
{
...
void bitSet::assign(const UList<bool>& bools)
{
...
void bitSet::set(const labelRange& range)
{
...
void bitSet::unset(const labelRange& range)
{
