...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
 ...
 namespace Foam{
labelHashSet HashSetOps::used(const bitSet& select)
{
...
labelHashSet HashSetOps::used(const UList<bool>& select)
{
...
bitSet HashSetOps::bitset(const labelHashSet& locations)
{
    bitSet output;
...
List<bool> HashSetOps::bools(const labelHashSet& locations)
{
