...
template<class Type>
Distribution<Type>::Distribution(const Type& binWidth)
:
    List<List<scalar>>(pTraits<Type>::nComponents),
    binWidth_(binWidth),
    listStarts_(pTraits<Type>::nComponents, 0)
...
template<class Type>
Distribution<Type>::Distribution(const Distribution<Type>& d)
:
...
template<class Type>
scalar Distribution<Type>::totalWeight(direction cmpt) const
{
...
template<class Type>
List<label> Distribution<Type>::keys(direction cmpt) const
{
...
template<class Type>
Pair<label> Distribution<Type>::validLimits
(
    direction cmpt
) const
{
...
template<class Type>
Type Distribution<Type>::mean() const
{
    Type meanValue(Zero);
...
template<class Type>
Type Distribution<Type>::median() const
{
...
template<class Type>
void Distribution<Type>::write(const fileName& filePrefix) const
{
    List<List<Pair<scalar>>> rawDistribution = raw();
...
template<class Type>
void Distribution<Type>::operator=
(
