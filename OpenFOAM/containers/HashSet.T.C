...
namespace Foam {
    ...
    HashSet<Key, Hash>::HashSet(const UList<Key>& lst)
        :
    ...
    template<class Key, class Hash>
    label HashSet<Key, Hash>::insert(const UList<Key>& lst)
    {
        label count = 0;
        forAll(lst, elemI)
        {
    ...
    template<class Key, class Hash>
    inline bool HashSet<Key, Hash>::operator[](const Key& key) const
    {
    ...
    template<class Key, class Hash>
    void HashSet<Key, Hash>::operator|=(const HashSet<Key, Hash>& rhs)
    {
