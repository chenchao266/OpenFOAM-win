...
template<class INew>
void HashPtrTable<T, Key, Hash>::readIstream
(
    Istream& is,
    const INew& inew
)
...
template<class T, class Key, class Hash>
template<class INew>
void HashPtrTable<T, Key, Hash>::read
(
...
template<class T, class Key, class Hash>
void HashPtrTable<T, Key, Hash>::write(Ostream& os) const
{
...
template<class T, class Key, class Hash>
template<class INew>
HashPtrTable<T, Key, Hash>::HashPtrTable(Istream& is, const INew& inew)
{
...
template<class T, class Key, class Hash>
HashPtrTable<T, Key, Hash>::HashPtrTable(const dictionary& dict)
{
