...
namespace Foam {
    ...
    UILList<LListBase, T>::UILList(const UILList<LListBase, T>& lst)
    {
    ...
    template<class LListBase, class T>
    void UILList<LListBase, T>::operator=(const UILList<LListBase, T>& rhs)
    {
        LListBase::clear();
    ...
    template<class LListBase, class T>
    bool UILList<LListBase, T>::operator==
        (
