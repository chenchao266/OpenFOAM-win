...
namespace Foam {
    ...
    NamedEnum<Enum, nEnum>::NamedEnum()
        :
    ...
    template<class Enum, int nEnum>
    Enum NamedEnum<Enum, nEnum>::read(Istream& is) const
    {
        const word name(is);
    ...
    template<class Enum, int nEnum>
    void NamedEnum<Enum, nEnum>::write(const Enum e, Ostream& os) const
    {
        os << operator[](e);
    }
    ...
    template<class Enum, int nEnum>
    stringList NamedEnum<Enum, nEnum>::strings()
    {
    ...
    template<class Enum, int nEnum>
    wordList NamedEnum<Enum, nEnum>::words()
    {
        wordList lst(nEnum);
