...
// * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class T>
PtrList<T>::PtrList(PtrList<T>& list, bool reuse)
:
...
template<class T>
PtrList<T>::PtrList(const SLPtrList<T>& list)
:
...
template<class T>
template<class... Args>
PtrList<T> PtrList<T>::clone(Args&&... args) const
{
    const label len = this->size();
...
template<class T>
void PtrList<T>::resize(const label newLen)
{
...
template<class T>
void PtrList<T>::operator=(const PtrList<T>& list)
{
    if (this == &list)
    {
