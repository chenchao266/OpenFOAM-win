...
template<class T, class Key, class Hash>
Ostream& HashTable<T, Key, Hash>::printInfo(Ostream& os) const
{
    label used = 0;
    label maxChain = 0;
    unsigned avgChain = 0;
...
template<class T, class Key, class Hash>
Ostream& HashTable<T, Key, Hash>::writeKeys
(
    Ostream& os,
...
template<class T, class Key, class Hash>
Istream& HashTable<T, Key, Hash>::readTable
(
    Istream& is
)
{
...
template<class T, class Key, class Hash>
Ostream& HashTable<T, Key, Hash>::writeTable
(
    Ostream& os
) const
{
