...
namespace Foam {
    template<class Type>
    void ParSortableList<Type>::write
    (
    ...
    template<class Type>
    void ParSortableList<Type>::copyInto
    (
    ...
    template<class Type>
    void ParSortableList<Type>::getPivots
    (
        const List<Type>& elems,
        List<Type>& pivots
    ) const
    ...
    template<class Type>
    void ParSortableList<Type>::checkAndSend
    (
        List<Type>& values,
        labelList& indices,
        const label bufSize,
    ...
    template<class Type>
    ParSortableList<Type>::ParSortableList(const UList<Type>& values)
        :
        List<Type>(values),
        indices_(0),
        procs_(0)
    ...
    template<class Type>
    ParSortableList<Type>::ParSortableList(const label size)
        :
        List<Type>(size),
        indices_(0),
        procs_(0)
    ...
    template<class Type>
    void ParSortableList<Type>::sort()
    {
        //
