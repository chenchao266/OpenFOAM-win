...
// See bitSet::set(labelRange) for original implementation
 ...
 namespace Foam{
void BitOps::set(List<bool>& bools, const labelRange& range)
{
...
// See bitSet::set(labelRange) for original implementation
void BitOps::set(labelHashSet& hashset, const labelRange& range)
{
    labelRange slice(range);
    slice.adjust();  // No negative start, size adjusted accordingly
...
void BitOps::set(bitSet& bitset, const labelRange& range)
{
    bitset.set(range);
}
...
void BitOps::unset(List<bool>& bools, const labelRange& range)
{
...
void BitOps::unset(labelHashSet& hashset, const labelRange& range)
{
    for (label i = range.first(); i <= range.last(); ++i)
    {
        hashset.unset(i);
...
void BitOps::unset(bitSet& bitset, const labelRange& range)
{
    bitset.unset(range);
}
