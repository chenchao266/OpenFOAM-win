...
namespace Foam {
    ...
    template<class T, class Key, class Hash>
    bool HashTable<T, Key, Hash>::iteratorBase::erase()
    {
    ...
    template<class T, class Key, class Hash>
    label HashTable<T, Key, Hash>::erase(const UList<Key>& keys)
    {
    ...
    template<class T, class Key, class Hash>
    void HashTable<T, Key, Hash>::shrink()
    {
