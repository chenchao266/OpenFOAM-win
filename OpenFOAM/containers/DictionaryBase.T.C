...
namespace Foam {
    ...
    template<class IDLListType, class T>
    DictionaryBase<IDLListType, T>::DictionaryBase(const label size)
        :
        hashedTs_(size)
    {}
    ...
    template<class IDLListType, class T>
    const T* DictionaryBase<IDLListType, T>::lookupPtr
    (
        const word& keyword
    ) const
    {
    ...
    template<class IDLListType, class T>
    T* DictionaryBase<IDLListType, T>::lookupPtr(const word& keyword)
    {
    ...
    template<class IDLListType, class T>
    wordList DictionaryBase<IDLListType, T>::sortedToc() const
    {
    ...
    template<class IDLListType, class T>
    void DictionaryBase<IDLListType, T>::transfer
    (
