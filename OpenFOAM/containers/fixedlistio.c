...
void FixedList<T, N>::writeEntry(Ostream& os) const
{
...
template<class T, unsigned N>
FixedList<T, N>::FixedList(Istream& is)
{
    this->readList(is);
}
...
template<class T, unsigned N>
Ostream& FixedList<T, N>::writeList
(
    Ostream& os,
...
template<class T, unsigned N>
Istream& FixedList<T, N>::readList
(
    Istream& is
)
{
