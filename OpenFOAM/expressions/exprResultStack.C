...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
expressions::exprResultStack::exprResultStack()
:
...
expressions::exprResult
expressions::exprResultStack::pop()
{
    exprResult result;
...
void expressions::exprResultStack::push(const exprResult& result)
{
...
void expressions::exprResultStack::operator=
(
    const exprResultStack& rhs
)
{
