...
** source file "fieldExprLemonParser.lyy". */
/*
** 2000-05-29
**
...
#line 2 "fieldExprLemonParser.lyy"
...
\*---------------------------------------------------------------------------*/
#line 99 "fieldExprLemonParser.lyy"
...
#line 167 "fieldExprLemonParser.cc"
...
static const char *const yyRuleName[] = {
 ...
 /*  23 */ "lfield ::= sfield LESS_EQ sfield",
 /*  24 */ "lfield ::= sfield GREATER sfield",
 /*  25 */ "lfield ::= sfield GREATER_EQ sfield",
 ...
 /*  78 */ "lfield ::= vfield LESS_EQ vfield",
 /*  79 */ "lfield ::= vfield GREATER vfield",
 /*  80 */ "lfield ::= vfield GREATER_EQ vfield",
 ...
 /* 110 */ "lfield ::= hfield LESS_EQ hfield",
 /* 111 */ "lfield ::= hfield GREATER hfield",
 /* 112 */ "lfield ::= hfield GREATER_EQ hfield",
 ...
 /* 134 */ "lfield ::= yfield LESS_EQ yfield",
 /* 135 */ "lfield ::= yfield GREATER yfield",
 /* 136 */ "lfield ::= yfield GREATER_EQ yfield",
 ...
 /* 165 */ "lfield ::= tfield LESS_EQ tfield",
 /* 166 */ "lfield ::= tfield GREATER tfield",
 /* 167 */ "lfield ::= tfield GREATER_EQ tfield",
...
/********* Begin destructor definitions ***************************************/
    ...
    case 99: /* DIAG */
{
#line 161 "fieldExprLemonParser.lyy"
 ((yypminor->yy0)).destroy(); 
#line 2010 "fieldExprLemonParser.cc"
}
      break;
    case 107: /* vvalue */
{
#line 239 "fieldExprLemonParser.lyy"
 delete((yypminor->yy67)); (yypminor->yy67) = nullptr; 
#line 2017 "fieldExprLemonParser.cc"
}
      break;
...
static const YYCODETYPE yyRuleInfoLhs[] = {
   ...
   100,  /* (23) lfield ::= sfield LESS_EQ sfield */
   100,  /* (24) lfield ::= sfield GREATER sfield */
   100,  /* (25) lfield ::= sfield GREATER_EQ sfield */
   ...
   100,  /* (78) lfield ::= vfield LESS_EQ vfield */
   100,  /* (79) lfield ::= vfield GREATER vfield */
   100,  /* (80) lfield ::= vfield GREATER_EQ vfield */
   ...
   100,  /* (110) lfield ::= hfield LESS_EQ hfield */
   100,  /* (111) lfield ::= hfield GREATER hfield */
   100,  /* (112) lfield ::= hfield GREATER_EQ hfield */
   ...
   100,  /* (134) lfield ::= yfield LESS_EQ yfield */
   100,  /* (135) lfield ::= yfield GREATER yfield */
   100,  /* (136) lfield ::= yfield GREATER_EQ yfield */
   ...
   100,  /* (165) lfield ::= tfield LESS_EQ tfield */
   100,  /* (166) lfield ::= tfield GREATER tfield */
   100,  /* (167) lfield ::= tfield GREATER_EQ tfield */
...
static const signed char yyRuleInfoNRhs[] = {
   ...
   -3,  /* (23) lfield ::= sfield LESS_EQ sfield */
   -3,  /* (24) lfield ::= sfield GREATER sfield */
   -3,  /* (25) lfield ::= sfield GREATER_EQ sfield */
   ...
   -3,  /* (78) lfield ::= vfield LESS_EQ vfield */
   -3,  /* (79) lfield ::= vfield GREATER vfield */
   -3,  /* (80) lfield ::= vfield GREATER_EQ vfield */
   ...
   -3,  /* (110) lfield ::= hfield LESS_EQ hfield */
   -3,  /* (111) lfield ::= hfield GREATER hfield */
   -3,  /* (112) lfield ::= hfield GREATER_EQ hfield */
   ...
   -3,  /* (134) lfield ::= yfield LESS_EQ yfield */
   -3,  /* (135) lfield ::= yfield GREATER yfield */
   -3,  /* (136) lfield ::= yfield GREATER_EQ yfield */
   ...
   -3,  /* (165) lfield ::= tfield LESS_EQ tfield */
   -3,  /* (166) lfield ::= tfield GREATER tfield */
   -3,  /* (167) lfield ::= tfield GREATER_EQ tfield */
...
#line 218 "fieldExprLemonParser.lyy"
{ yymsp[-2].minor.yy44 = Foam::degToRad(); }
#line 2872 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 219 "fieldExprLemonParser.lyy"
{ yymsp[-2].minor.yy44 = Foam::radToDeg(); }
#line 2881 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 220 "fieldExprLemonParser.lyy"
{ yymsp[-2].minor.yy44 = driver->argValue(); }
#line 2890 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 221 "fieldExprLemonParser.lyy"
{ yymsp[-2].minor.yy44 = driver->timeValue(); }
#line 2899 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 222 "fieldExprLemonParser.lyy"
{ yymsp[-2].minor.yy44 = driver->deltaT(); }
#line 2908 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
      case 8: /* svalue ::= SCALAR_FUNCTION_ID LPAREN RPAREN */
#line 225 "fieldExprLemonParser.lyy"
{
...
#line 290 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3006 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 305 "fieldExprLemonParser.lyy"
{
...
#line 3051 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 22: /* lfield ::= sfield LESS sfield */
#line 317 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy102), make_obj(yymsp[0].minor.yy102), Foam::lessOp<Foam::scalar>());
}
#line 3061 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 23: /* lfield ::= sfield LESS_EQ sfield */
#line 323 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy102), make_obj(yymsp[0].minor.yy102), Foam::lessEqOp<Foam::scalar>());
}
#line 3071 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 24: /* lfield ::= sfield GREATER sfield */
#line 329 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 3081 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 25: /* lfield ::= sfield GREATER_EQ sfield */
#line 335 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy102), make_obj(yymsp[0].minor.yy102), Foam::greaterEqOp<Foam::scalar>());
}
#line 3091 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 26: /* sfield ::= lfield QUESTION sfield COLON sfield */
#line 341 "fieldExprLemonParser.lyy"
{
...
#line 3103 "fieldExprLemonParser.cc"
...
#line 3191 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,22,&yymsp[-1].minor);
  yymsp[-2].minor.yy102 = yylhsminor.yy102;
        break;
      case 35: /* sfield ::= sfield PERCENT sfield */
#line 400 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy102 = driver->newField<Foam::scalar>().ptr();
    Foam::FieldOps::assign
    (
...
#line 422 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::log (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3237 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 427 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::log10 (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3248 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 432 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::sqr (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3259 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 437 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::sqrt (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3270 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 442 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::cbrt (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3281 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 447 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::sin (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3292 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 452 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::cos (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3303 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 457 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::tan (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3314 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 462 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::asin (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3325 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 467 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::acos (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3336 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 472 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::atan (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3347 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 477 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::sinh (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3358 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 482 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::cosh (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3369 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 487 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::tanh (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3380 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 502 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::pos (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3415 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 507 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::neg (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3426 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 512 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::pos0 (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3437 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 517 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::neg0 (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3448 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 522 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::sign (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 3459 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 530 "fieldExprLemonParser.lyy"
{
...
#line 3471 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 559 "fieldExprLemonParser.lyy"
{
    yymsp[-2].minor.yy102 = driver->field_rand().ptr();
}
#line 3518 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 609 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy199 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy199)).ptr();
}
#line 3605 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3650 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 77: /* lfield ::= vfield LESS vfield */
#line 636 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy199), make_obj(yymsp[0].minor.yy199), Foam::lessOp<Foam::vector>());
}
#line 3660 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 78: /* lfield ::= vfield LESS_EQ vfield */
#line 642 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy199), make_obj(yymsp[0].minor.yy199), Foam::lessEqOp<Foam::vector>());
}
#line 3670 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 79: /* lfield ::= vfield GREATER vfield */
#line 648 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 3680 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 80: /* lfield ::= vfield GREATER_EQ vfield */
#line 654 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy199), make_obj(yymsp[0].minor.yy199), Foam::greaterEqOp<Foam::vector>());
}
#line 3690 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 81: /* vfield ::= lfield QUESTION vfield COLON vfield */
#line 660 "fieldExprLemonParser.lyy"
{
...
#line 3702 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 799 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy210 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy210)).ptr();
}
#line 3929 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 814 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 3964 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 108: /* lfield ::= hfield NOT_EQUAL hfield */
#line 820 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 3974 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 109: /* lfield ::= hfield LESS hfield */
#line 826 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 3984 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 110: /* lfield ::= hfield LESS_EQ hfield */
#line 832 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy210), make_obj(yymsp[0].minor.yy210), Foam::lessEqOp<Foam::sphericalTensor>());
}
#line 3994 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 111: /* lfield ::= hfield GREATER hfield */
#line 838 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 4004 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 112: /* lfield ::= hfield GREATER_EQ hfield */
#line 844 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy210), make_obj(yymsp[0].minor.yy210), Foam::greaterEqOp<Foam::sphericalTensor>());
}
#line 4014 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 113: /* hfield ::= lfield QUESTION hfield COLON hfield */
#line 850 "fieldExprLemonParser.lyy"
{
...
#line 4026 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 941 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy79 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy79)).ptr();
}
#line 4174 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 956 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 4209 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 132: /* lfield ::= yfield NOT_EQUAL yfield */
#line 962 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 4219 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 133: /* lfield ::= yfield LESS yfield */
#line 968 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy79), make_obj(yymsp[0].minor.yy79), Foam::lessOp<Foam::symmTensor>());
}
#line 4229 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 134: /* lfield ::= yfield LESS_EQ yfield */
#line 974 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy79), make_obj(yymsp[0].minor.yy79), Foam::lessEqOp<Foam::symmTensor>());
}
#line 4239 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 135: /* lfield ::= yfield GREATER yfield */
#line 980 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
...
#line 4249 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 136: /* lfield ::= yfield GREATER_EQ yfield */
#line 986 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy79), make_obj(yymsp[0].minor.yy79), Foam::greaterEqOp<Foam::symmTensor>());
}
#line 4259 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 137: /* yfield ::= lfield QUESTION yfield COLON yfield */
#line 992 "fieldExprLemonParser.lyy"
{
...
#line 4271 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 1114 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy89 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy89)).ptr();
}
#line 4480 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1129 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy89), make_obj(yymsp[0].minor.yy89), Foam::equalOp<Foam::tensor>());
}
#line 4515 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 163: /* lfield ::= tfield NOT_EQUAL tfield */
#line 1135 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy89), make_obj(yymsp[0].minor.yy89), Foam::notEqualOp<Foam::tensor>());
}
#line 4525 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 164: /* lfield ::= tfield LESS tfield */
#line 1141 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy89), make_obj(yymsp[0].minor.yy89), Foam::lessOp<Foam::tensor>());
}
#line 4535 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 165: /* lfield ::= tfield LESS_EQ tfield */
#line 1147 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy89), make_obj(yymsp[0].minor.yy89), Foam::lessEqOp<Foam::tensor>());
}
#line 4545 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 166: /* lfield ::= tfield GREATER tfield */
#line 1153 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy89), make_obj(yymsp[0].minor.yy89), Foam::greaterOp<Foam::tensor>());
}
#line 4555 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 167: /* lfield ::= tfield GREATER_EQ tfield */
#line 1159 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = driver->newField<bool>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy46, make_obj(yymsp[-2].minor.yy89), make_obj(yymsp[0].minor.yy89), Foam::greaterEqOp<Foam::tensor>());
}
#line 4565 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 168: /* tfield ::= lfield QUESTION tfield COLON tfield */
#line 1165 "fieldExprLemonParser.lyy"
{
...
#line 4577 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,26,&yymsp[-3].minor);
#line 1323 "fieldExprLemonParser.lyy"
{
...
#line 4887 "fieldExprLemonParser.cc"
}
        break;
      case 201: /* lfield ::= lfield LAND lfield */
#line 1351 "fieldExprLemonParser.lyy"
{
...
#line 4900 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,7,&yymsp[-1].minor);
  yymsp[-2].minor.yy46 = yylhsminor.yy46;
        break;
      case 202: /* lfield ::= lfield LOR lfield */
#line 1361 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy46 = yymsp[-2].minor.yy46;
    Foam::FieldOps::assign
    (
...
#line 4930 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,79,&yymsp[-3].minor);
#line 1391 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::mag (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 4941 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1396 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy102)).ptr();
}
#line 4952 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,79,&yymsp[-3].minor);
#line 1402 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::mag (make_tmp(yymsp[-1].minor.yy199)).ptr();
}
#line 4963 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,80,&yymsp[-3].minor);
#line 1407 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy199)).ptr();
}
#line 4974 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,79,&yymsp[-3].minor);
#line 1413 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::mag (make_tmp(yymsp[-1].minor.yy89)).ptr();
}
#line 4985 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,80,&yymsp[-3].minor);
#line 1418 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy89)).ptr();
}
#line 4996 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,79,&yymsp[-3].minor);
#line 1424 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::mag (make_tmp(yymsp[-1].minor.yy79)).ptr();
}
#line 5007 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,80,&yymsp[-3].minor);
#line 1429 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy79)).ptr();
}
#line 5018 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,79,&yymsp[-3].minor);
#line 1435 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::mag (make_tmp(yymsp[-1].minor.yy210)).ptr();
}
#line 5029 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,80,&yymsp[-3].minor);
#line 1440 "fieldExprLemonParser.lyy"
{
    yymsp[-3].minor.yy102 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy210)).ptr();
}
#line 5040 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1447 "fieldExprLemonParser.lyy"
{
...
#line 5059 "fieldExprLemonParser.cc"
...
#line 1464 "fieldExprLemonParser.lyy"
{
...
#line 5086 "fieldExprLemonParser.cc"
...
#line 1487 "fieldExprLemonParser.lyy"
{
...
#line 5116 "fieldExprLemonParser.cc"
...
#line 1503 "fieldExprLemonParser.lyy"
{
...
#line 1621 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy79 = yymsp[-4].minor.yy79; // no-op
}
#line 5389 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,98,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 1626 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy210 = yymsp[-4].minor.yy210; // no-op
}
#line 5401 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,98,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 1632 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy199 = driver->newField<Foam::vector>().ptr();

    Foam::unzipDiag((make_obj(yymsp[-4].minor.yy79)), (*yylhsminor.yy199));
}
#line 5415 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
...
#line 1639 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy199 = driver->newField<Foam::vector>().ptr();

    Foam::unzipDiag((make_obj(yymsp[-4].minor.yy89)), (*yylhsminor.yy199));
}
#line 5429 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,99,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 1646 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy199 = driver->newField<Foam::vector>().ptr();
...
#line 5448 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,85,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 1658 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy199 = driver->newField<Foam::vector>().ptr();
...
#line 5467 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,86,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 1670 "fieldExprLemonParser.lyy"
{
    yylhsminor.yy199 = driver->newField<Foam::vector>().ptr();
...
#line 5486 "fieldExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,87,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 154 "fieldExprLemonParser.lyy"
 driver->reportFatal("Parse failure, giving up..."); 
#line 5537 "fieldExprLemonParser.cc"
...
#line 155 "fieldExprLemonParser.lyy"
 driver->reportFatal("Syntax error"); 
#line 5558 "fieldExprLemonParser.cc"
...
#line 1691 "fieldExprLemonParser.lyy"
...
#line 5925 "fieldExprLemonParser.cc"
