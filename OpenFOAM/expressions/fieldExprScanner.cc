...
// * * * * * * * * * * * * * * * * Destructor  * * * * * * * * * * * * * * * //
 ...
 namespace Foam{
expressions::fieldExpr::scanner::~scanner()
{
    if (parser_)
    {
        delete parser_;
...
bool expressions::fieldExpr::scanner::dispatch_method
(
...
bool expressions::fieldExpr::scanner::dispatch_ident
(
    const parseDriver& driver_,
    word ident
) const
...
bool expressions::fieldExpr::scanner::process
(
