...
expressions::exprDriver::readExpression
(
    const word& name,
...
List<expressions::exprString>
expressions::exprDriver::readVariableStrings
(
    const dictionary& dict,
    const word& keyword,
    bool mandatory
...
label expressions::exprDriver::setVariableStrings
(
    const dictionary& dict,
    bool mandatory
)
...
Ostream& expressions::exprDriver::writeVariableStrings
(
    Ostream& os,
    const word& keyword
) const
