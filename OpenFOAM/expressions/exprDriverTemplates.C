...
// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
Type expressions::exprDriver::exprDriver::weightedAverage
(
...
template<class Type>
Type expressions::exprDriver::exprDriver::weightedSum
(
    const scalarField& wfield,
    const Field<Type>& fld
)
...
template<class Type>
tmp<Field<Type>>
expressions::exprDriver::getResult(bool wantPointData)
{
...
template<class Type>
const Function1<Type>* expressions::exprDriver::getFunction1Ptr
(
    const word& name,
...
template<class Type>
bool expressions::exprDriver::isFunction(const word& name) const
{
...
template<class Type>
Type expressions::exprDriver::getFunctionValue
(
    const word& name,
    const scalar x
) const
...
template<class Type>
void expressions::exprDriver::fillFunctionValues
(
    Field<Type>& result,
    const word& name,
...
template<class Type>
bool expressions::exprDriver::isLocalVariable
(
    const word& name,
    bool wantPointData,
    label expectedSize
...
template<class Type>
tmp<Field<Type>>
expressions::exprDriver::newField
(
    const Type& val
) const
{
...
template<class Type>
tmp<Field<Type>>
expressions::exprDriver::newPointField
(
    const Type& val
) const
{
