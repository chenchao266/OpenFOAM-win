...
// * * * * * * * * * * * * * Static Member Functions * * * * * * * * * * * * //
 ...
 namespace Foam{
void expressions::exprString::inplaceExpand
(
    std::string& str,
...
expressions::exprString
expressions::exprString::getOptional
(
    const word& key,
    const dictionary& dict,
    const bool stripComments
...
void expressions::exprString::expand
(
    const dictionary& dict,
    const bool stripComments
)
...
void expressions::exprString::trim()
{
    stringOps::inplaceTrim(*this);
}


bool expressions::exprString::readEntry
(
    const word& keyword,
    const dictionary& dict,
    bool mandatory,
...
bool expressions::exprString::writeEntry
(
    const word& keyword,
    Ostream& os,
    bool writeEmpty
