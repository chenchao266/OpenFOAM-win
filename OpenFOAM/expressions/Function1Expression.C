...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
 ...
 namespace Foam{
template<class Type>
Function1Types::Function1Expression<Type>::Function1Expression
(
...
template<class Type>
Type Function1Types::Function1Expression<Type>::value
(
    const scalar x
) const
{
...
template<class Type>
Type Function1Types::Function1Expression<Type>::integrate
(
    const scalar x1,
    const scalar x2
) const
...
template<class Type>
void Function1Types::Function1Expression<Type>::writeData
(
    Ostream& os
) const
{
