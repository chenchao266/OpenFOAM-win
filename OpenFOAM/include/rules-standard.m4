...
# Example
 ...
 namespace Foam{
#     rules_standard(sfield, scalar, lfield)
#------------------------------------------------------------------------------
...
rule_negate_op($@)
dnl
rule_const_multiply($1, $1, degToRad(), DEG_TO_RAD)
rule_const_multiply($1, $1, radToDeg(), RAD_TO_DEG)
rule_binary_func($1, $1, $1, MIN, min)
rule_binary_func($1, $1, $1, MAX, max)
dnl
