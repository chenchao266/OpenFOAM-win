...
namespace Foam
{
    ...
    refPtr<fileOperation::dirIndexList>
        fileOperations::uncollatedFileOperation::lookupProcessorsPath
        (
    ...
    off_t fileOperations::uncollatedFileOperation::fileSize
    (
        const fileName& fName,
        const bool followLink
    ) const
