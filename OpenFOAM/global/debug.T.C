...
int debug::debugSwitch(const char* name, const int defaultValue)
{
...
int debug::infoSwitch(const char* name, const int defaultValue)
{
...
int debug::optimisationSwitch(const char* name, const int defaultValue)
{
...
float debug::floatOptimisationSwitch
(
    const char* name,
