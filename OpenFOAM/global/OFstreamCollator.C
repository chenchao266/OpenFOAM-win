...
namespace Foam
{
    ...
    bool OFstreamCollator::writeFile
    (
        const label comm,
    ...
    void* OFstreamCollator::writeAll(void *threadarg)
    {
    ...
    void OFstreamCollator::waitForBufferSpace(const off_t wantedSize) const
    {
        while (true)
        {
    ...
    OFstreamCollator::OFstreamCollator(const off_t maxBufferSize)
        :
    ...
    OFstreamCollator::OFstreamCollator
    (
