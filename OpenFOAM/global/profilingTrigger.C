...
profilingTrigger::profilingTrigger(const char* name)
:
    ptr_(profiling::New(name))
{}


profilingTrigger::profilingTrigger(const string& name)
:
    ptr_(profiling::New(name))
{}
...
bool profilingTrigger::running() const
{
    return ptr_;
}


void profilingTrigger::stop()
{
    if (ptr_)
    {
