...
std::string foamVersion::configuredProjectDir()
{
...
std::string foamVersion::configuredEtcDir()
{
...
void foamVersion::printBuildInfo(std::ostream& os, const bool full)
{
