...
int debug::debugSwitch(const char* name, const int deflt)
{
    return getOrAdd(debugSwitches(), name, deflt);
}


int debug::infoSwitch(const char* name, const int deflt)
{
    return getOrAdd(infoSwitches(), name, deflt);
}


int debug::optimisationSwitch(const char* name, const int deflt)
{
    return getOrAdd(optimisationSwitches(), name, deflt);
}


float debug::floatOptimisationSwitch(const char* name, const float deflt)
{
    return getOrAdd(optimisationSwitches(), name, deflt);
}


void debug::addDebugObject(const char* name, simpleRegIOobject* obj)
{
    appendNamedEntry(debugObjects(), name, obj);
}


void debug::addInfoObject(const char* name, simpleRegIOobject* obj)
{
    appendNamedEntry(infoObjects(), name, obj);
}


void debug::addOptimisationObject
(
    const char* name,
    simpleRegIOobject* obj
)
...
void debug::addDimensionSetObject
(
    const char* name,
    simpleRegIOobject* obj
)
...
void debug::addDimensionedConstantObject
(
    const char* name,
    simpleRegIOobject* obj
)
...
simpleObjectRegistry& debug::debugObjects()
{
    if (!debugObjectsPtr_)
    {
...
simpleObjectRegistry& debug::infoObjects()
{
    if (!infoObjectsPtr_)
    {
...
simpleObjectRegistry& debug::optimisationObjects()
{
...
simpleObjectRegistry& debug::dimensionSetObjects()
{
...
simpleObjectRegistry& debug::dimensionedConstantObjects()
{
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
 ...
 namespace Foam{
void debug::listSwitches(const bool unset)
{
    listSwitches
    (
...
void debug::listDebugSwitches(const bool unset)
{
    listSwitches
    (
        debug::debugSwitches().sortedToc(),
...
void debug::listInfoSwitches(const bool unset)
{
    listSwitches
    (
        wordList::null(),
...
void debug::listOptimisationSwitches(const bool unset)
{
    listSwitches
    (
        wordList::null(),
...
void debug::listRegisteredSwitches(const bool unset)
{
    listSwitches
    (
...
void debug::listRegisteredDebugSwitches(const bool unset)
{
    listSwitches
    (
        debug::debugObjects().sortedToc(),
...
void debug::listRegisteredInfoSwitches(const bool unset)
{
    listSwitches
    (
        wordList::null(),
...
void debug::listRegisteredOptimisationSwitches(const bool unset)
{
    listSwitches
    (
        wordList::null(),
