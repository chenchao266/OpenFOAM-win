...
template<class Type>
void fvMeshAdder::MapSurfaceField
(
    const mapAddedPolyMesh& meshMap,
...
template<class Type>
void fvMeshAdder::MapSurfaceFields
(
    const mapAddedPolyMesh& meshMap,
    const fvMesh& mesh,
    const fvMesh& meshToAdd
