...
namespace Foam {
    ...
    void fvMeshDistribute::printFieldInfo(const fvMesh& mesh)
    {
    ...
    void fvMeshDistribute::saveBoundaryFields
    (
    ...
    ) const
    {
        ...
        typedef GeometricField<Type, fvsPatchField, Mesh> fldType;
    ...
    template<class Type, class Mesh>
    void fvMeshDistribute::mapBoundaryFields
    (
    ...
    template<class Type>
    void fvMeshDistribute::saveInternalFields
    (
    ...
    template<class Type>
    void fvMeshDistribute::mapExposedFaces
    (
        const mapPolyMesh& map,
    ...
    )
    {
        ...
        forAllIter(typename HashTable<fldType*>, flds, iter)
        {
            ...
            const Field<Type>& oldInternal = oldFlds[fieldI++];
    ...
    void fvMeshDistribute::initPatchFields
    (
    ...
    template<class GeoField>
    void fvMeshDistribute::correctBoundaryConditions()
    {
    ...
    template<class GeoField>
    void fvMeshDistribute::sendFields
    (
        const label domain,
    ...
    template<class GeoField>
    void fvMeshDistribute::receiveFields
    (
        const label domain,
        const wordList& fieldNames,
        fvMesh& mesh,
