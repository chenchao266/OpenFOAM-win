...
** source file "volumeExprLemonParser.lyy". */
/*
** 2000-05-29
**
...
#line 2 "volumeExprLemonParser.lyy"
...
\*---------------------------------------------------------------------------*/
#line 43 "volumeExprLemonParser.lyy"
...
#line 117 "volumeExprLemonParser.cc"
...
static const char *const yyRuleName[] = {
 ...
 /*  24 */ "lfield ::= sfield LESS_EQ sfield",
 /*  25 */ "lfield ::= sfield GREATER sfield",
 /*  26 */ "lfield ::= sfield GREATER_EQ sfield",
 ...
 /*  79 */ "lfield ::= vfield LESS_EQ vfield",
 /*  80 */ "lfield ::= vfield GREATER vfield",
 /*  81 */ "lfield ::= vfield GREATER_EQ vfield",
 ...
 /* 111 */ "lfield ::= hfield LESS_EQ hfield",
 /* 112 */ "lfield ::= hfield GREATER hfield",
 /* 113 */ "lfield ::= hfield GREATER_EQ hfield",
 ...
 /* 135 */ "lfield ::= yfield LESS_EQ yfield",
 /* 136 */ "lfield ::= yfield GREATER yfield",
 /* 137 */ "lfield ::= yfield GREATER_EQ yfield",
 ...
 /* 166 */ "lfield ::= tfield LESS_EQ tfield",
 /* 167 */ "lfield ::= tfield GREATER tfield",
 /* 168 */ "lfield ::= tfield GREATER_EQ tfield",
 ...
 /* 229 */ "slfield ::= ssfield LESS_EQ ssfield",
 /* 230 */ "slfield ::= ssfield GREATER ssfield",
 /* 231 */ "slfield ::= ssfield GREATER_EQ ssfield",
 ...
 /* 282 */ "slfield ::= svfield LESS_EQ svfield",
 /* 283 */ "slfield ::= svfield GREATER svfield",
 /* 284 */ "slfield ::= svfield GREATER_EQ svfield",
 ...
 /* 314 */ "slfield ::= shfield LESS_EQ shfield",
 /* 315 */ "slfield ::= shfield GREATER shfield",
 /* 316 */ "slfield ::= shfield GREATER_EQ shfield",
 ...
 /* 338 */ "slfield ::= syfield LESS_EQ syfield",
 /* 339 */ "slfield ::= syfield GREATER syfield",
 /* 340 */ "slfield ::= syfield GREATER_EQ syfield",
 ...
 /* 368 */ "slfield ::= stfield LESS_EQ stfield",
 /* 369 */ "slfield ::= stfield GREATER stfield",
 /* 370 */ "slfield ::= stfield GREATER_EQ stfield",
 ...
 /* 432 */ "plfield ::= psfield LESS_EQ psfield",
 /* 433 */ "plfield ::= psfield GREATER psfield",
 /* 434 */ "plfield ::= psfield GREATER_EQ psfield",
 ...
 /* 480 */ "plfield ::= pvfield LESS_EQ pvfield",
 /* 481 */ "plfield ::= pvfield GREATER pvfield",
 /* 482 */ "plfield ::= pvfield GREATER_EQ pvfield",
 ...
 /* 512 */ "plfield ::= phfield LESS_EQ phfield",
 /* 513 */ "plfield ::= phfield GREATER phfield",
 /* 514 */ "plfield ::= phfield GREATER_EQ phfield",
 ...
 /* 536 */ "plfield ::= pyfield LESS_EQ pyfield",
 /* 537 */ "plfield ::= pyfield GREATER pyfield",
 /* 538 */ "plfield ::= pyfield GREATER_EQ pyfield",
 ...
 /* 566 */ "plfield ::= ptfield LESS_EQ ptfield",
 /* 567 */ "plfield ::= ptfield GREATER ptfield",
 /* 568 */ "plfield ::= ptfield GREATER_EQ ptfield",
...
{
#line 111 "volumeExprLemonParser.lyy"
 ((yypminor->yy0)).destroy(); 
#line 4680 "volumeExprLemonParser.cc"
}
      break;
    case 145: /* identifier */
{
#line 178 "volumeExprLemonParser.lyy"
 delete((yypminor->yy194)); (yypminor->yy194) = nullptr; 
#line 4687 "volumeExprLemonParser.cc"
}
      break;
    case 147: /* vvalue */
{
#line 217 "volumeExprLemonParser.lyy"
 delete((yypminor->yy35)); (yypminor->yy35) = nullptr; 
#line 4694 "volumeExprLemonParser.cc"
}
      break;
...
static const YYCODETYPE yyRuleInfoLhs[] = {
   ...
   127,  /* (24) lfield ::= sfield LESS_EQ sfield */
   127,  /* (25) lfield ::= sfield GREATER sfield */
   127,  /* (26) lfield ::= sfield GREATER_EQ sfield */
   ...
   127,  /* (79) lfield ::= vfield LESS_EQ vfield */
   127,  /* (80) lfield ::= vfield GREATER vfield */
   127,  /* (81) lfield ::= vfield GREATER_EQ vfield */
   ...
   127,  /* (111) lfield ::= hfield LESS_EQ hfield */
   127,  /* (112) lfield ::= hfield GREATER hfield */
   127,  /* (113) lfield ::= hfield GREATER_EQ hfield */
   ...
   127,  /* (135) lfield ::= yfield LESS_EQ yfield */
   127,  /* (136) lfield ::= yfield GREATER yfield */
   127,  /* (137) lfield ::= yfield GREATER_EQ yfield */
   ...
   127,  /* (166) lfield ::= tfield LESS_EQ tfield */
   127,  /* (167) lfield ::= tfield GREATER tfield */
   127,  /* (168) lfield ::= tfield GREATER_EQ tfield */
   ...
   133,  /* (229) slfield ::= ssfield LESS_EQ ssfield */
   133,  /* (230) slfield ::= ssfield GREATER ssfield */
   133,  /* (231) slfield ::= ssfield GREATER_EQ ssfield */
   ...
   133,  /* (282) slfield ::= svfield LESS_EQ svfield */
   133,  /* (283) slfield ::= svfield GREATER svfield */
   133,  /* (284) slfield ::= svfield GREATER_EQ svfield */
   ...
   133,  /* (314) slfield ::= shfield LESS_EQ shfield */
   133,  /* (315) slfield ::= shfield GREATER shfield */
   133,  /* (316) slfield ::= shfield GREATER_EQ shfield */
   ...
   133,  /* (338) slfield ::= syfield LESS_EQ syfield */
   133,  /* (339) slfield ::= syfield GREATER syfield */
   133,  /* (340) slfield ::= syfield GREATER_EQ syfield */
   ...
   133,  /* (368) slfield ::= stfield LESS_EQ stfield */
   133,  /* (369) slfield ::= stfield GREATER stfield */
   133,  /* (370) slfield ::= stfield GREATER_EQ stfield */
   ...
   139,  /* (432) plfield ::= psfield LESS_EQ psfield */
   139,  /* (433) plfield ::= psfield GREATER psfield */
   139,  /* (434) plfield ::= psfield GREATER_EQ psfield */
   ...
   139,  /* (480) plfield ::= pvfield LESS_EQ pvfield */
   139,  /* (481) plfield ::= pvfield GREATER pvfield */
   139,  /* (482) plfield ::= pvfield GREATER_EQ pvfield */
   ...
   139,  /* (512) plfield ::= phfield LESS_EQ phfield */
   139,  /* (513) plfield ::= phfield GREATER phfield */
   139,  /* (514) plfield ::= phfield GREATER_EQ phfield */
   ...
   139,  /* (536) plfield ::= pyfield LESS_EQ pyfield */
   139,  /* (537) plfield ::= pyfield GREATER pyfield */
   139,  /* (538) plfield ::= pyfield GREATER_EQ pyfield */
   ...
   139,  /* (566) plfield ::= ptfield LESS_EQ ptfield */
   139,  /* (567) plfield ::= ptfield GREATER ptfield */
   139,  /* (568) plfield ::= ptfield GREATER_EQ ptfield */
...
static const signed char yyRuleInfoNRhs[] = {
   ...
   -3,  /* (24) lfield ::= sfield LESS_EQ sfield */
   -3,  /* (25) lfield ::= sfield GREATER sfield */
   -3,  /* (26) lfield ::= sfield GREATER_EQ sfield */
   ...
   -3,  /* (79) lfield ::= vfield LESS_EQ vfield */
   -3,  /* (80) lfield ::= vfield GREATER vfield */
   -3,  /* (81) lfield ::= vfield GREATER_EQ vfield */
   ...
   -3,  /* (111) lfield ::= hfield LESS_EQ hfield */
   -3,  /* (112) lfield ::= hfield GREATER hfield */
   -3,  /* (113) lfield ::= hfield GREATER_EQ hfield */
   ...
   -3,  /* (135) lfield ::= yfield LESS_EQ yfield */
   -3,  /* (136) lfield ::= yfield GREATER yfield */
   -3,  /* (137) lfield ::= yfield GREATER_EQ yfield */
   ...
   -3,  /* (166) lfield ::= tfield LESS_EQ tfield */
   -3,  /* (167) lfield ::= tfield GREATER tfield */
   -3,  /* (168) lfield ::= tfield GREATER_EQ tfield */
   ...
   -3,  /* (229) slfield ::= ssfield LESS_EQ ssfield */
   -3,  /* (230) slfield ::= ssfield GREATER ssfield */
   -3,  /* (231) slfield ::= ssfield GREATER_EQ ssfield */
   ...
   -3,  /* (282) slfield ::= svfield LESS_EQ svfield */
   -3,  /* (283) slfield ::= svfield GREATER svfield */
   -3,  /* (284) slfield ::= svfield GREATER_EQ svfield */
   ...
   -3,  /* (314) slfield ::= shfield LESS_EQ shfield */
   -3,  /* (315) slfield ::= shfield GREATER shfield */
   -3,  /* (316) slfield ::= shfield GREATER_EQ shfield */
   ...
   -3,  /* (338) slfield ::= syfield LESS_EQ syfield */
   -3,  /* (339) slfield ::= syfield GREATER syfield */
   -3,  /* (340) slfield ::= syfield GREATER_EQ syfield */
   ...
   -3,  /* (368) slfield ::= stfield LESS_EQ stfield */
   -3,  /* (369) slfield ::= stfield GREATER stfield */
   -3,  /* (370) slfield ::= stfield GREATER_EQ stfield */
   ...
   -3,  /* (432) plfield ::= psfield LESS_EQ psfield */
   -3,  /* (433) plfield ::= psfield GREATER psfield */
   -3,  /* (434) plfield ::= psfield GREATER_EQ psfield */
   ...
   -3,  /* (480) plfield ::= pvfield LESS_EQ pvfield */
   -3,  /* (481) plfield ::= pvfield GREATER pvfield */
   -3,  /* (482) plfield ::= pvfield GREATER_EQ pvfield */
   ...
   -3,  /* (512) plfield ::= phfield LESS_EQ phfield */
   -3,  /* (513) plfield ::= phfield GREATER phfield */
   -3,  /* (514) plfield ::= phfield GREATER_EQ phfield */
   ...
   -3,  /* (536) plfield ::= pyfield LESS_EQ pyfield */
   -3,  /* (537) plfield ::= pyfield GREATER pyfield */
   -3,  /* (538) plfield ::= pyfield GREATER_EQ pyfield */
   ...
   -3,  /* (566) plfield ::= ptfield LESS_EQ ptfield */
   -3,  /* (567) plfield ::= ptfield GREATER ptfield */
   -3,  /* (568) plfield ::= ptfield GREATER_EQ ptfield */
...
#line 196 "volumeExprLemonParser.lyy"
{ yymsp[-2].minor.yy92 = Foam::degToRad(); }
#line 6580 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 197 "volumeExprLemonParser.lyy"
{ yymsp[-2].minor.yy92 = Foam::radToDeg(); }
#line 6589 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 198 "volumeExprLemonParser.lyy"
{ yymsp[-2].minor.yy92 = driver->argValue(); }
#line 6598 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 199 "volumeExprLemonParser.lyy"
{ yymsp[-2].minor.yy92 = driver->timeValue(); }
#line 6607 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 200 "volumeExprLemonParser.lyy"
{ yymsp[-2].minor.yy92 = driver->deltaT(); }
#line 6616 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
      case 9: /* svalue ::= SCALAR_FUNCTION_ID LPAREN RPAREN */
#line 203 "volumeExprLemonParser.lyy"
{
...
#line 268 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 6715 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 283 "volumeExprLemonParser.lyy"
{
...
#line 6750 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 22: /* lfield ::= sfield NOT_EQUAL sfield */
#line 289 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy31), make_obj(yymsp[0].minor.yy31), Foam::notEqualOp<Foam::scalar>());
}
#line 6760 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 23: /* lfield ::= sfield LESS sfield */
#line 295 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy31), make_obj(yymsp[0].minor.yy31), Foam::lessOp<Foam::scalar>());
}
#line 6770 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 24: /* lfield ::= sfield LESS_EQ sfield */
#line 301 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy31), make_obj(yymsp[0].minor.yy31), Foam::lessEqOp<Foam::scalar>());
}
#line 6780 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 25: /* lfield ::= sfield GREATER sfield */
#line 307 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy31), make_obj(yymsp[0].minor.yy31), Foam::greaterOp<Foam::scalar>());
}
#line 6790 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 26: /* lfield ::= sfield GREATER_EQ sfield */
#line 313 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy31), make_obj(yymsp[0].minor.yy31), Foam::greaterEqOp<Foam::scalar>());
}
#line 6800 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 27: /* sfield ::= lfield QUESTION sfield COLON sfield */
#line 319 "volumeExprLemonParser.lyy"
{
...
#line 6816 "volumeExprLemonParser.cc"
...
#line 6904 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,22,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 36: /* sfield ::= sfield PERCENT sfield */
#line 382 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign
    (
...
#line 404 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::log (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 6950 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 409 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::log10 (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 6961 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 414 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::sqr (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 6972 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 419 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::sqrt (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 6983 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 424 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::cbrt (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 6994 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 429 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::sin (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7005 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 434 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::cos (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7016 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 439 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::tan (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7027 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 444 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::asin (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7038 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 449 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::acos (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7049 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 454 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::atan (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7060 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 459 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::sinh (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7071 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 464 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::cosh (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7082 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 469 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::tanh (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7093 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 484 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::pos (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7128 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 489 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::neg (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7139 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 494 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::pos0 (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7150 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 499 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::neg0 (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7161 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 504 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::sign (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 7172 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 512 "volumeExprLemonParser.lyy"
{
...
#line 7184 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 532 "volumeExprLemonParser.lyy"
{
...
#line 7220 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-4].minor);
  yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
...
#line 542 "volumeExprLemonParser.lyy"
{
    yymsp[-2].minor.yy31 = driver->field_rand().ptr();
}
#line 7232 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 547 "volumeExprLemonParser.lyy"
{
...
#line 7244 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
      case 66: /* sfield ::= SCALAR_FUNCTION_ID LPAREN sfield RPAREN */
#line 553 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 593 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy160 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy160)).ptr();
}
#line 7320 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 7365 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 78: /* lfield ::= vfield LESS vfield */
#line 620 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy160), make_obj(yymsp[0].minor.yy160), Foam::lessOp<Foam::vector>());
}
#line 7375 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 79: /* lfield ::= vfield LESS_EQ vfield */
#line 626 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy160), make_obj(yymsp[0].minor.yy160), Foam::lessEqOp<Foam::vector>());
}
#line 7385 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 80: /* lfield ::= vfield GREATER vfield */
#line 632 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7395 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 81: /* lfield ::= vfield GREATER_EQ vfield */
#line 638 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy160), make_obj(yymsp[0].minor.yy160), Foam::greaterEqOp<Foam::vector>());
}
#line 7405 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 82: /* vfield ::= lfield QUESTION vfield COLON vfield */
#line 644 "volumeExprLemonParser.lyy"
{
...
#line 7421 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 787 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy37 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy37)).ptr();
}
#line 7648 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 802 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7683 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 109: /* lfield ::= hfield NOT_EQUAL hfield */
#line 808 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7693 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 110: /* lfield ::= hfield LESS hfield */
#line 814 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7703 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 111: /* lfield ::= hfield LESS_EQ hfield */
#line 820 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy37), make_obj(yymsp[0].minor.yy37), Foam::lessEqOp<Foam::sphericalTensor>());
}
#line 7713 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 112: /* lfield ::= hfield GREATER hfield */
#line 826 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7723 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 113: /* lfield ::= hfield GREATER_EQ hfield */
#line 832 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy37), make_obj(yymsp[0].minor.yy37), Foam::greaterEqOp<Foam::sphericalTensor>());
}
#line 7733 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 114: /* hfield ::= lfield QUESTION hfield COLON hfield */
#line 838 "volumeExprLemonParser.lyy"
{
...
#line 7749 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 931 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy122 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy122)).ptr();
}
#line 7897 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 946 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7932 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 133: /* lfield ::= yfield NOT_EQUAL yfield */
#line 952 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7942 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 134: /* lfield ::= yfield LESS yfield */
#line 958 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7952 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 135: /* lfield ::= yfield LESS_EQ yfield */
#line 964 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy122), make_obj(yymsp[0].minor.yy122), Foam::lessEqOp<Foam::symmTensor>());
}
#line 7962 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 136: /* lfield ::= yfield GREATER yfield */
#line 970 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 7972 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 137: /* lfield ::= yfield GREATER_EQ yfield */
#line 976 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy122), make_obj(yymsp[0].minor.yy122), Foam::greaterEqOp<Foam::symmTensor>());
}
#line 7982 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 138: /* yfield ::= lfield QUESTION yfield COLON yfield */
#line 982 "volumeExprLemonParser.lyy"
{
...
#line 7998 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 1107 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy4 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy4)).ptr();
}
#line 8207 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1122 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy4), make_obj(yymsp[0].minor.yy4), Foam::equalOp<Foam::tensor>());
}
#line 8242 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 164: /* lfield ::= tfield NOT_EQUAL tfield */
#line 1128 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy4), make_obj(yymsp[0].minor.yy4), Foam::notEqualOp<Foam::tensor>());
}
#line 8252 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 165: /* lfield ::= tfield LESS tfield */
#line 1134 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy4), make_obj(yymsp[0].minor.yy4), Foam::lessOp<Foam::tensor>());
}
#line 8262 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 166: /* lfield ::= tfield LESS_EQ tfield */
#line 1140 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy4), make_obj(yymsp[0].minor.yy4), Foam::lessEqOp<Foam::tensor>());
}
#line 8272 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 167: /* lfield ::= tfield GREATER tfield */
#line 1146 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy4), make_obj(yymsp[0].minor.yy4), Foam::greaterOp<Foam::tensor>());
}
#line 8282 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 168: /* lfield ::= tfield GREATER_EQ tfield */
#line 1152 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy31, make_obj(yymsp[-2].minor.yy4), make_obj(yymsp[0].minor.yy4), Foam::greaterEqOp<Foam::tensor>());
}
#line 8292 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 169: /* tfield ::= lfield QUESTION tfield COLON tfield */
#line 1158 "volumeExprLemonParser.lyy"
{
...
#line 8308 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,26,&yymsp[-3].minor);
#line 1318 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = driver->newVolField<Foam::scalar>().ptr();
...
#line 8586 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1331 "volumeExprLemonParser.lyy"
{
...
#line 8602 "volumeExprLemonParser.cc"
}
        break;
      case 201: /* lfield ::= lfield LAND lfield */
#line 1341 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = yymsp[-2].minor.yy31;
    Foam::FieldOps::assign
    (
...
#line 8615 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,7,&yymsp[-1].minor);
  yymsp[-2].minor.yy31 = yylhsminor.yy31;
        break;
      case 202: /* lfield ::= lfield LOR lfield */
#line 1351 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy31 = yymsp[-2].minor.yy31;
    Foam::FieldOps::assign
    (
...
#line 8647 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1369 "volumeExprLemonParser.lyy"
{
    yymsp[-2].minor.yy31 = driver->field_cellVolume().ptr();
}
#line 8658 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1373 "volumeExprLemonParser.lyy"
{
    yymsp[-2].minor.yy160 = driver->field_cellCentre().ptr();
}
#line 8669 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 1452 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 8843 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1467 "volumeExprLemonParser.lyy"
{
...
#line 8878 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 227: /* slfield ::= ssfield NOT_EQUAL ssfield */
#line 1473 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy47), make_obj(yymsp[0].minor.yy47), Foam::notEqualOp<Foam::scalar>());
}
#line 8888 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 228: /* slfield ::= ssfield LESS ssfield */
#line 1479 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy47), make_obj(yymsp[0].minor.yy47), Foam::lessOp<Foam::scalar>());
}
#line 8898 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 229: /* slfield ::= ssfield LESS_EQ ssfield */
#line 1485 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy47), make_obj(yymsp[0].minor.yy47), Foam::lessEqOp<Foam::scalar>());
}
#line 8908 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 230: /* slfield ::= ssfield GREATER ssfield */
#line 1491 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy47), make_obj(yymsp[0].minor.yy47), Foam::greaterOp<Foam::scalar>());
}
#line 8918 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 231: /* slfield ::= ssfield GREATER_EQ ssfield */
#line 1497 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy47), make_obj(yymsp[0].minor.yy47), Foam::greaterEqOp<Foam::scalar>());
}
#line 8928 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 232: /* ssfield ::= slfield QUESTION ssfield COLON ssfield */
#line 1503 "volumeExprLemonParser.lyy"
{
...
#line 8944 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
#line 9032 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,22,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 241: /* ssfield ::= ssfield PERCENT ssfield */
#line 1566 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign
    (
...
{  yy_destructor(yypParser,47,&yymsp[-3].minor);
#line 1588 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::log (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9078 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,48,&yymsp[-3].minor);
#line 1593 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::log10 (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9089 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,49,&yymsp[-3].minor);
#line 1598 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::sqr (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9100 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,50,&yymsp[-3].minor);
#line 1603 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::sqrt (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9111 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,51,&yymsp[-3].minor);
#line 1608 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::cbrt (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9122 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,52,&yymsp[-3].minor);
#line 1613 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::sin (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9133 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,53,&yymsp[-3].minor);
#line 1618 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::cos (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9144 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,54,&yymsp[-3].minor);
#line 1623 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::tan (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9155 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,55,&yymsp[-3].minor);
#line 1628 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::asin (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9166 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,56,&yymsp[-3].minor);
#line 1633 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::acos (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9177 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,57,&yymsp[-3].minor);
#line 1638 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::atan (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9188 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,58,&yymsp[-3].minor);
#line 1643 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::sinh (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9199 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,59,&yymsp[-3].minor);
#line 1648 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::cosh (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9210 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,60,&yymsp[-3].minor);
#line 1653 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::tanh (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9221 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,63,&yymsp[-3].minor);
#line 1668 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::pos (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9256 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,64,&yymsp[-3].minor);
#line 1673 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::neg (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9267 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,65,&yymsp[-3].minor);
#line 1678 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::pos0 (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9278 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,66,&yymsp[-3].minor);
#line 1683 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::neg0 (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9289 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,67,&yymsp[-3].minor);
#line 1688 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::sign (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 9300 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,68,&yymsp[-3].minor);
#line 1696 "volumeExprLemonParser.lyy"
{
...
#line 9312 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,71,&yymsp[-5].minor);
#line 1716 "volumeExprLemonParser.lyy"
{
...
#line 9348 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-4].minor);
  yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
...
#line 1723 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    driver->fillFunctionValues<Foam::scalar>
    (
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 1763 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy176 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy176)).ptr();
}
#line 9428 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 9473 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 281: /* slfield ::= svfield LESS svfield */
#line 1790 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy176), make_obj(yymsp[0].minor.yy176), Foam::lessOp<Foam::vector>());
}
#line 9483 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 282: /* slfield ::= svfield LESS_EQ svfield */
#line 1796 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy176), make_obj(yymsp[0].minor.yy176), Foam::lessEqOp<Foam::vector>());
}
#line 9493 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 283: /* slfield ::= svfield GREATER svfield */
#line 1802 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 9503 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 284: /* slfield ::= svfield GREATER_EQ svfield */
#line 1808 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy176), make_obj(yymsp[0].minor.yy176), Foam::greaterEqOp<Foam::vector>());
}
#line 9513 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 285: /* svfield ::= slfield QUESTION svfield COLON svfield */
#line 1814 "volumeExprLemonParser.lyy"
{
...
#line 9529 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 1954 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy75 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy75)).ptr();
}
#line 9756 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 1969 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 9791 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 312: /* slfield ::= shfield NOT_EQUAL shfield */
#line 1975 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 9801 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 313: /* slfield ::= shfield LESS shfield */
#line 1981 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 9811 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 314: /* slfield ::= shfield LESS_EQ shfield */
#line 1987 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy75), make_obj(yymsp[0].minor.yy75), Foam::lessEqOp<Foam::sphericalTensor>());
}
#line 9821 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 315: /* slfield ::= shfield GREATER shfield */
#line 1993 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 9831 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 316: /* slfield ::= shfield GREATER_EQ shfield */
#line 1999 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy75), make_obj(yymsp[0].minor.yy75), Foam::greaterEqOp<Foam::sphericalTensor>());
}
#line 9841 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 317: /* shfield ::= slfield QUESTION shfield COLON shfield */
#line 2005 "volumeExprLemonParser.lyy"
{
...
#line 9857 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 2100 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy168 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy168)).ptr();
}
#line 10005 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 2115 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 10040 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 336: /* slfield ::= syfield NOT_EQUAL syfield */
#line 2121 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 10050 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 337: /* slfield ::= syfield LESS syfield */
#line 2127 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 10060 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 338: /* slfield ::= syfield LESS_EQ syfield */
#line 2133 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy168), make_obj(yymsp[0].minor.yy168), Foam::lessEqOp<Foam::symmTensor>());
}
#line 10070 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 339: /* slfield ::= syfield GREATER syfield */
#line 2139 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 10080 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 340: /* slfield ::= syfield GREATER_EQ syfield */
#line 2145 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy168), make_obj(yymsp[0].minor.yy168), Foam::greaterEqOp<Foam::symmTensor>());
}
#line 10090 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 341: /* syfield ::= slfield QUESTION syfield COLON syfield */
#line 2151 "volumeExprLemonParser.lyy"
{
...
#line 10106 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 2276 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy20 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy20)).ptr();
}
#line 10308 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 2291 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy20), make_obj(yymsp[0].minor.yy20), Foam::equalOp<Foam::tensor>());
}
#line 10343 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 366: /* slfield ::= stfield NOT_EQUAL stfield */
#line 2297 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy20), make_obj(yymsp[0].minor.yy20), Foam::notEqualOp<Foam::tensor>());
}
#line 10353 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 367: /* slfield ::= stfield LESS stfield */
#line 2303 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy20), make_obj(yymsp[0].minor.yy20), Foam::lessOp<Foam::tensor>());
}
#line 10363 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 368: /* slfield ::= stfield LESS_EQ stfield */
#line 2309 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy20), make_obj(yymsp[0].minor.yy20), Foam::lessEqOp<Foam::tensor>());
}
#line 10373 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 369: /* slfield ::= stfield GREATER stfield */
#line 2315 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy20), make_obj(yymsp[0].minor.yy20), Foam::greaterOp<Foam::tensor>());
}
#line 10383 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 370: /* slfield ::= stfield GREATER_EQ stfield */
#line 2321 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy47, make_obj(yymsp[-2].minor.yy20), make_obj(yymsp[0].minor.yy20), Foam::greaterEqOp<Foam::tensor>());
}
#line 10393 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 371: /* stfield ::= slfield QUESTION stfield COLON stfield */
#line 2327 "volumeExprLemonParser.lyy"
{
...
#line 10409 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
#line 10578 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,22,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 389: /* stfield ::= svfield TIMES svfield */
#line 2435 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy20 = (make_tmp(yymsp[-2].minor.yy176) * make_tmp(yymsp[0].minor.yy176)).ptr();
}
#line 10587 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,21,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 390: /* stfield ::= stfield BIT_AND stfield */
#line 2440 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy20 = (make_tmp(yymsp[-2].minor.yy20) & make_tmp(yymsp[0].minor.yy20)).ptr();
}
#line 10596 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 391: /* stfield ::= stfield BIT_AND shfield */
#line 2445 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy20 = (make_tmp(yymsp[-2].minor.yy20) & make_tmp(yymsp[0].minor.yy75)).ptr();
}
#line 10605 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 392: /* stfield ::= stfield BIT_AND syfield */
#line 2450 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy20 = (make_tmp(yymsp[-2].minor.yy20) & make_tmp(yymsp[0].minor.yy168)).ptr();
}
#line 10614 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 393: /* stfield ::= shfield BIT_AND stfield */
#line 2455 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy20 = (make_tmp(yymsp[-2].minor.yy75) & make_tmp(yymsp[0].minor.yy20)).ptr();
}
#line 10623 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 394: /* stfield ::= syfield BIT_AND stfield */
#line 2460 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy20 = (make_tmp(yymsp[-2].minor.yy168) & make_tmp(yymsp[0].minor.yy20)).ptr();
}
#line 10632 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 395: /* stfield ::= syfield BIT_AND syfield */
#line 2465 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy20 = (make_tmp(yymsp[-2].minor.yy168) & make_tmp(yymsp[0].minor.yy168)).ptr();
}
#line 10641 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy20 = yylhsminor.yy20;
        break;
      case 396: /* evaluate ::= slfield */
#line 2477 "volumeExprLemonParser.lyy"
{ driver->setResult(yymsp[0].minor.yy47, true); /* Logical */ }
#line 10648 "volumeExprLemonParser.cc"
        break;
      case 397: /* slfield ::= FACE_EXPR LPAREN LTRUE RPAREN */
{  yy_destructor(yypParser,83,&yymsp[-3].minor);
#line 2479 "volumeExprLemonParser.lyy"
{ yymsp[-3].minor.yy47 = driver->newSurfaceField<Foam::scalar>(Foam::scalar(1)).ptr(); }
#line 10654 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
...
{  yy_destructor(yypParser,26,&yymsp[-3].minor);
#line 2483 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = yymsp[-1].minor.yy47;
}
#line 10676 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,26,&yymsp[-3].minor);
#line 2488 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
...
#line 10693 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,8,&yymsp[-1].minor);
#line 2501 "volumeExprLemonParser.lyy"
{
...
#line 10709 "volumeExprLemonParser.cc"
}
        break;
      case 403: /* slfield ::= slfield LAND slfield */
#line 2511 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = yymsp[-2].minor.yy47;
    Foam::FieldOps::assign
    (
...
#line 10722 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,7,&yymsp[-1].minor);
  yymsp[-2].minor.yy47 = yylhsminor.yy47;
        break;
      case 404: /* slfield ::= slfield LOR slfield */
#line 2521 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy47 = yymsp[-2].minor.yy47;
    Foam::FieldOps::assign
    (
...
#line 10753 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 2538 "volumeExprLemonParser.lyy"
{
    yymsp[-2].minor.yy47 = driver->field_faceArea().ptr();
}
#line 10764 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 2542 "volumeExprLemonParser.lyy"
{
    yymsp[-2].minor.yy176 = driver->field_faceCentre().ptr();
}
#line 10775 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 2546 "volumeExprLemonParser.lyy"
{
    yymsp[-2].minor.yy176 = driver->field_areaNormal().ptr();
}
#line 10786 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 2629 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy94)).ptr();
}
#line 10960 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 2644 "volumeExprLemonParser.lyy"
{
...
#line 10995 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 430: /* plfield ::= psfield NOT_EQUAL psfield */
#line 2650 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy94), make_obj(yymsp[0].minor.yy94), Foam::notEqualOp<Foam::scalar>());
}
#line 11005 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 431: /* plfield ::= psfield LESS psfield */
#line 2656 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy94), make_obj(yymsp[0].minor.yy94), Foam::lessOp<Foam::scalar>());
}
#line 11015 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 432: /* plfield ::= psfield LESS_EQ psfield */
#line 2662 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy94), make_obj(yymsp[0].minor.yy94), Foam::lessEqOp<Foam::scalar>());
}
#line 11025 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 433: /* plfield ::= psfield GREATER psfield */
#line 2668 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy94), make_obj(yymsp[0].minor.yy94), Foam::greaterOp<Foam::scalar>());
}
#line 11035 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 434: /* plfield ::= psfield GREATER_EQ psfield */
#line 2674 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy94), make_obj(yymsp[0].minor.yy94), Foam::greaterEqOp<Foam::scalar>());
}
#line 11045 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 435: /* psfield ::= plfield QUESTION psfield COLON psfield */
#line 2680 "volumeExprLemonParser.lyy"
{
...
#line 11061 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,68,&yymsp[-3].minor);
#line 2718 "volumeExprLemonParser.lyy"
{
...
#line 11117 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,71,&yymsp[-5].minor);
#line 2738 "volumeExprLemonParser.lyy"
{
...
#line 11153 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-4].minor);
  yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
...
#line 2745 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    driver->fillFunctionValues<Foam::scalar>
    (
...
#line 11220 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,22,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 449: /* psfield ::= psfield PERCENT psfield */
#line 2798 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign
    (
...
{  yy_destructor(yypParser,61,&yymsp[-5].minor);
#line 2907 "volumeExprLemonParser.lyy"
{
    yymsp[-5].minor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 11439 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-4].minor);
  yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 2958 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy223 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy223)).ptr();
}
#line 11517 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 11562 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 479: /* plfield ::= pvfield LESS pvfield */
#line 2985 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy223), make_obj(yymsp[0].minor.yy223), Foam::lessOp<Foam::vector>());
}
#line 11572 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 480: /* plfield ::= pvfield LESS_EQ pvfield */
#line 2991 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy223), make_obj(yymsp[0].minor.yy223), Foam::lessEqOp<Foam::vector>());
}
#line 11582 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 481: /* plfield ::= pvfield GREATER pvfield */
#line 2997 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 11592 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 482: /* plfield ::= pvfield GREATER_EQ pvfield */
#line 3003 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy223), make_obj(yymsp[0].minor.yy223), Foam::greaterEqOp<Foam::vector>());
}
#line 11602 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 483: /* pvfield ::= plfield QUESTION pvfield COLON pvfield */
#line 3009 "volumeExprLemonParser.lyy"
{
...
#line 11618 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 3149 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy104 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy104)).ptr();
}
#line 11845 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3164 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 11880 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 510: /* plfield ::= phfield NOT_EQUAL phfield */
#line 3170 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 11890 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 511: /* plfield ::= phfield LESS phfield */
#line 3176 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 11900 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 512: /* plfield ::= phfield LESS_EQ phfield */
#line 3182 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy104), make_obj(yymsp[0].minor.yy104), Foam::lessEqOp<Foam::sphericalTensor>());
}
#line 11910 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 513: /* plfield ::= phfield GREATER phfield */
#line 3188 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 11920 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 514: /* plfield ::= phfield GREATER_EQ phfield */
#line 3194 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy104), make_obj(yymsp[0].minor.yy104), Foam::greaterEqOp<Foam::sphericalTensor>());
}
#line 11930 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 515: /* phfield ::= plfield QUESTION phfield COLON phfield */
#line 3200 "volumeExprLemonParser.lyy"
{
...
#line 11946 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 3295 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy83 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy83)).ptr();
}
#line 12094 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3310 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 12129 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 534: /* plfield ::= pyfield NOT_EQUAL pyfield */
#line 3316 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 12139 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 535: /* plfield ::= pyfield LESS pyfield */
#line 3322 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy83), make_obj(yymsp[0].minor.yy83), Foam::lessOp<Foam::symmTensor>());
}
#line 12149 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 536: /* plfield ::= pyfield LESS_EQ pyfield */
#line 3328 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy83), make_obj(yymsp[0].minor.yy83), Foam::lessEqOp<Foam::symmTensor>());
}
#line 12159 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 537: /* plfield ::= pyfield GREATER pyfield */
#line 3334 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
...
#line 12169 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 538: /* plfield ::= pyfield GREATER_EQ pyfield */
#line 3340 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy83), make_obj(yymsp[0].minor.yy83), Foam::greaterEqOp<Foam::symmTensor>());
}
#line 12179 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 539: /* pyfield ::= plfield QUESTION pyfield COLON pyfield */
#line 3346 "volumeExprLemonParser.lyy"
{
...
#line 12195 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
{  yy_destructor(yypParser,34,&yymsp[-3].minor);
#line 3471 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy67 = ((Foam::radToDeg()) * make_tmp(yymsp[-1].minor.yy67)).ptr();
}
#line 12397 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3486 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy67), make_obj(yymsp[0].minor.yy67), Foam::equalOp<Foam::tensor>());
}
#line 12432 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,13,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 564: /* plfield ::= ptfield NOT_EQUAL ptfield */
#line 3492 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy67), make_obj(yymsp[0].minor.yy67), Foam::notEqualOp<Foam::tensor>());
}
#line 12442 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,14,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 565: /* plfield ::= ptfield LESS ptfield */
#line 3498 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy67), make_obj(yymsp[0].minor.yy67), Foam::lessOp<Foam::tensor>());
}
#line 12452 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,15,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 566: /* plfield ::= ptfield LESS_EQ ptfield */
#line 3504 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy67), make_obj(yymsp[0].minor.yy67), Foam::lessEqOp<Foam::tensor>());
}
#line 12462 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,16,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 567: /* plfield ::= ptfield GREATER ptfield */
#line 3510 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy67), make_obj(yymsp[0].minor.yy67), Foam::greaterOp<Foam::tensor>());
}
#line 12472 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,17,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 568: /* plfield ::= ptfield GREATER_EQ ptfield */
#line 3516 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign(*yylhsminor.yy94, make_obj(yymsp[-2].minor.yy67), make_obj(yymsp[0].minor.yy67), Foam::greaterEqOp<Foam::tensor>());
}
#line 12482 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,18,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 569: /* ptfield ::= plfield QUESTION ptfield COLON ptfield */
#line 3522 "volumeExprLemonParser.lyy"
{
...
#line 12498 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,4,&yymsp[-3].minor);
  yy_destructor(yypParser,5,&yymsp[-1].minor);
...
#line 12667 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,22,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 587: /* ptfield ::= pvfield TIMES pvfield */
#line 3630 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy67 = (make_tmp(yymsp[-2].minor.yy223) * make_tmp(yymsp[0].minor.yy223)).ptr();
}
#line 12676 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,21,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 588: /* ptfield ::= ptfield BIT_AND ptfield */
#line 3635 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy67 = (make_tmp(yymsp[-2].minor.yy67) & make_tmp(yymsp[0].minor.yy67)).ptr();
}
#line 12685 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 589: /* ptfield ::= ptfield BIT_AND phfield */
#line 3640 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy67 = (make_tmp(yymsp[-2].minor.yy67) & make_tmp(yymsp[0].minor.yy104)).ptr();
}
#line 12694 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 590: /* ptfield ::= ptfield BIT_AND pyfield */
#line 3645 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy67 = (make_tmp(yymsp[-2].minor.yy67) & make_tmp(yymsp[0].minor.yy83)).ptr();
}
#line 12703 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 591: /* ptfield ::= phfield BIT_AND ptfield */
#line 3650 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy67 = (make_tmp(yymsp[-2].minor.yy104) & make_tmp(yymsp[0].minor.yy67)).ptr();
}
#line 12712 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 592: /* ptfield ::= pyfield BIT_AND ptfield */
#line 3655 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy67 = (make_tmp(yymsp[-2].minor.yy83) & make_tmp(yymsp[0].minor.yy67)).ptr();
}
#line 12721 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 593: /* ptfield ::= pyfield BIT_AND pyfield */
#line 3660 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy67 = (make_tmp(yymsp[-2].minor.yy83) & make_tmp(yymsp[0].minor.yy83)).ptr();
}
#line 12730 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,11,&yymsp[-1].minor);
  yymsp[-2].minor.yy67 = yylhsminor.yy67;
        break;
      case 594: /* evaluate ::= plfield */
#line 3671 "volumeExprLemonParser.lyy"
{ driver->setResult(yymsp[0].minor.yy94, true); /* Logical */ }
#line 12737 "volumeExprLemonParser.cc"
        break;
      case 595: /* plfield ::= POINT_EXPR LPAREN LTRUE RPAREN */
{  yy_destructor(yypParser,93,&yymsp[-3].minor);
#line 3673 "volumeExprLemonParser.lyy"
{ yymsp[-3].minor.yy94 = driver->newPointField<Foam::scalar>(Foam::scalar(1)).ptr(); }
#line 12743 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,27,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
...
{  yy_destructor(yypParser,93,&yymsp[-3].minor);
#line 3674 "volumeExprLemonParser.lyy"
{ yymsp[-3].minor.yy94 = driver->newPointField<Foam::scalar>(Foam::scalar(0)).ptr(); }
#line 12753 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,28,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
...
{  yy_destructor(yypParser,8,&yymsp[-1].minor);
#line 3677 "volumeExprLemonParser.lyy"
{
...
#line 12770 "volumeExprLemonParser.cc"
}
        break;
      case 599: /* plfield ::= plfield LAND plfield */
#line 3687 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = yymsp[-2].minor.yy94;
    Foam::FieldOps::assign
    (
...
#line 12783 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,7,&yymsp[-1].minor);
  yymsp[-2].minor.yy94 = yylhsminor.yy94;
        break;
      case 600: /* plfield ::= plfield LOR plfield */
#line 3697 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy94 = yymsp[-2].minor.yy94;
    Foam::FieldOps::assign
    (
...
#line 12814 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3714 "volumeExprLemonParser.lyy"
{
    yymsp[-2].minor.yy223 = driver->field_pointField().ptr();
}
#line 12825 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,81,&yymsp[-3].minor);
#line 3718 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = yymsp[-1].minor.yy94; *yymsp[-3].minor.yy94 = Foam::gAverage (*yymsp[-3].minor.yy94);
}
#line 12836 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,81,&yymsp[-3].minor);
#line 3722 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy223 = yymsp[-1].minor.yy223; *yymsp[-3].minor.yy223 = Foam::gAverage (*yymsp[-3].minor.yy223);
}
#line 12847 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,81,&yymsp[-3].minor);
#line 3726 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy104 = yymsp[-1].minor.yy104; *yymsp[-3].minor.yy104 = Foam::gAverage (*yymsp[-3].minor.yy104);
}
#line 12858 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,81,&yymsp[-3].minor);
#line 3730 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy83 = yymsp[-1].minor.yy83; *yymsp[-3].minor.yy83 = Foam::gAverage (*yymsp[-3].minor.yy83);
}
#line 12869 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,81,&yymsp[-3].minor);
#line 3734 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy67 = yymsp[-1].minor.yy67; *yymsp[-3].minor.yy67 = Foam::gAverage (*yymsp[-3].minor.yy67);
}
#line 12880 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,82,&yymsp[-3].minor);
#line 3738 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = yymsp[-1].minor.yy94; *yymsp[-3].minor.yy94 = Foam::gSum (*yymsp[-3].minor.yy94);
}
#line 12891 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,82,&yymsp[-3].minor);
#line 3742 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy223 = yymsp[-1].minor.yy223; *yymsp[-3].minor.yy223 = Foam::gSum (*yymsp[-3].minor.yy223);
}
#line 12902 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,82,&yymsp[-3].minor);
#line 3746 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy104 = yymsp[-1].minor.yy104; *yymsp[-3].minor.yy104 = Foam::gSum (*yymsp[-3].minor.yy104);
}
#line 12913 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,82,&yymsp[-3].minor);
#line 3750 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy83 = yymsp[-1].minor.yy83; *yymsp[-3].minor.yy83 = Foam::gSum (*yymsp[-3].minor.yy83);
}
#line 12924 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,82,&yymsp[-3].minor);
#line 3754 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy67 = yymsp[-1].minor.yy67; *yymsp[-3].minor.yy67 = Foam::gSum (*yymsp[-3].minor.yy67);
}
#line 12935 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3768 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = driver->newVolField<Foam::scalar>().ptr();
    Foam::FieldOps::assign
    (
...
#line 12952 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 3779 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::mag (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 12963 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3784 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy31)).ptr();
}
#line 12974 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 3790 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::mag (make_tmp(yymsp[-1].minor.yy160)).ptr();
}
#line 12985 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 3795 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy160)).ptr();
}
#line 12996 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 3801 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::mag (make_tmp(yymsp[-1].minor.yy4)).ptr();
}
#line 13007 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 3806 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy4)).ptr();
}
#line 13018 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 3812 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::mag (make_tmp(yymsp[-1].minor.yy122)).ptr();
}
#line 13029 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 3817 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy122)).ptr();
}
#line 13040 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 3823 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::mag (make_tmp(yymsp[-1].minor.yy37)).ptr();
}
#line 13051 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 3828 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy37)).ptr();
}
#line 13062 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 3835 "volumeExprLemonParser.lyy"
{
...
#line 13081 "volumeExprLemonParser.cc"
...
#line 3852 "volumeExprLemonParser.lyy"
{
...
#line 13108 "volumeExprLemonParser.cc"
...
#line 3875 "volumeExprLemonParser.lyy"
{
...
#line 13138 "volumeExprLemonParser.cc"
...
#line 3891 "volumeExprLemonParser.lyy"
{
...
#line 4009 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy122 = yymsp[-4].minor.yy122; // no-op
}
#line 13411 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,121,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4014 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy37 = yymsp[-4].minor.yy37; // no-op
}
#line 13423 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,121,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4020 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy160 = driver->newVolField<Foam::vector>().ptr();

    Foam::unzipDiag((make_obj(yymsp[-4].minor.yy122)), (*yylhsminor.yy160));
}
#line 13437 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
...
#line 4027 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy160 = driver->newVolField<Foam::vector>().ptr();

    Foam::unzipDiag((make_obj(yymsp[-4].minor.yy4)), (*yylhsminor.yy160));
}
#line 13451 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,122,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4034 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy160 = driver->newVolField<Foam::vector>().ptr();
...
#line 13470 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,108,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4046 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy160 = driver->newVolField<Foam::vector>().ptr();
...
#line 13489 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,109,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4058 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy160 = driver->newVolField<Foam::vector>().ptr();
...
#line 13508 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,110,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4072 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy31 = driver->pointToCell(make_obj(yymsp[-1].minor.yy94)).ptr();
}
#line 13521 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,123,&yymsp[-3].minor);
#line 4082 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy4 = driver->pointToCell(make_obj(yymsp[-1].minor.yy67)).ptr();
}
#line 13543 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,123,&yymsp[-3].minor);
#line 4087 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy122 = driver->pointToCell(make_obj(yymsp[-1].minor.yy83)).ptr();
}
#line 13554 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,123,&yymsp[-3].minor);
#line 4092 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy37 = driver->pointToCell(make_obj(yymsp[-1].minor.yy104)).ptr();
}
#line 13565 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4108 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = driver->newSurfaceField<Foam::scalar>().ptr();
    Foam::FieldOps::assign
    (
...
#line 13593 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4119 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::mag (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 13604 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4124 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy47)).ptr();
}
#line 13615 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4130 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::mag (make_tmp(yymsp[-1].minor.yy176)).ptr();
}
#line 13626 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4135 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy176)).ptr();
}
#line 13637 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4141 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::mag (make_tmp(yymsp[-1].minor.yy20)).ptr();
}
#line 13648 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4146 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy20)).ptr();
}
#line 13659 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4152 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::mag (make_tmp(yymsp[-1].minor.yy168)).ptr();
}
#line 13670 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4157 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy168)).ptr();
}
#line 13681 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4163 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::mag (make_tmp(yymsp[-1].minor.yy75)).ptr();
}
#line 13692 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4168 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy75)).ptr();
}
#line 13703 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,104,&yymsp[-7].minor);
#line 4175 "volumeExprLemonParser.lyy"
{
...
#line 13722 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-6].minor);
  yy_destructor(yypParser,3,&yymsp[-4].minor);
  yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
{  yy_destructor(yypParser,105,&yymsp[-19].minor);
#line 4192 "volumeExprLemonParser.lyy"
{
...
#line 13749 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-18].minor);
  yy_destructor(yypParser,3,&yymsp[-16].minor);
  yy_destructor(yypParser,3,&yymsp[-14].minor);
  yy_destructor(yypParser,3,&yymsp[-12].minor);
...
{  yy_destructor(yypParser,106,&yymsp[-13].minor);
#line 4215 "volumeExprLemonParser.lyy"
{
...
#line 13779 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-12].minor);
  yy_destructor(yypParser,3,&yymsp[-10].minor);
  yy_destructor(yypParser,3,&yymsp[-8].minor);
  yy_destructor(yypParser,3,&yymsp[-6].minor);
...
{  yy_destructor(yypParser,107,&yymsp[-3].minor);
#line 4231 "volumeExprLemonParser.lyy"
{
...
#line 4349 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy168 = yymsp[-4].minor.yy168; // no-op
}
#line 14052 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,121,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4354 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy75 = yymsp[-4].minor.yy75; // no-op
}
#line 14064 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,121,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4360 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy176 = driver->newSurfaceField<Foam::vector>().ptr();

    Foam::unzipDiag((make_obj(yymsp[-4].minor.yy168)), (*yylhsminor.yy176));
}
#line 14078 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,122,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4367 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy176 = driver->newSurfaceField<Foam::vector>().ptr();

    Foam::unzipDiag((make_obj(yymsp[-4].minor.yy20)), (*yylhsminor.yy176));
}
#line 14092 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,122,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4374 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy176 = driver->newSurfaceField<Foam::vector>().ptr();
...
#line 14111 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,108,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4386 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy176 = driver->newSurfaceField<Foam::vector>().ptr();
...
#line 14130 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,109,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4398 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy176 = driver->newSurfaceField<Foam::vector>().ptr();
...
#line 14149 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,110,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4412 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy47 = driver->cellToFace(make_obj(yymsp[-1].minor.yy31)).ptr();
}
#line 14162 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,125,&yymsp[-3].minor);
#line 4417 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy176 = driver->cellToFace(make_obj(yymsp[-1].minor.yy160)).ptr();
}
#line 14173 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,125,&yymsp[-3].minor);
#line 4422 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy20 = driver->cellToFace(make_obj(yymsp[-1].minor.yy4)).ptr();
}
#line 14184 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,125,&yymsp[-3].minor);
#line 4427 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy168 = driver->cellToFace(make_obj(yymsp[-1].minor.yy122)).ptr();
}
#line 14195 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,125,&yymsp[-3].minor);
#line 4432 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy75 = driver->cellToFace(make_obj(yymsp[-1].minor.yy37)).ptr();
}
#line 14206 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4444 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = driver->newPointField<Foam::scalar>().ptr();
    Foam::FieldOps::assign
    (
...
#line 14223 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4455 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::mag (make_tmp(yymsp[-1].minor.yy94)).ptr();
}
#line 14234 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4460 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy94)).ptr();
}
#line 14245 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4466 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::mag (make_tmp(yymsp[-1].minor.yy223)).ptr();
}
#line 14256 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4471 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy223)).ptr();
}
#line 14267 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4477 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::mag (make_tmp(yymsp[-1].minor.yy67)).ptr();
}
#line 14278 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4482 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy67)).ptr();
}
#line 14289 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4488 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::mag (make_tmp(yymsp[-1].minor.yy83)).ptr();
}
#line 14300 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4493 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy83)).ptr();
}
#line 14311 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,102,&yymsp[-3].minor);
#line 4499 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::mag (make_tmp(yymsp[-1].minor.yy104)).ptr();
}
#line 14322 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,103,&yymsp[-3].minor);
#line 4504 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = Foam::magSqr (make_tmp(yymsp[-1].minor.yy104)).ptr();
}
#line 14333 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,104,&yymsp[-7].minor);
#line 4511 "volumeExprLemonParser.lyy"
{
...
#line 14352 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-6].minor);
  yy_destructor(yypParser,3,&yymsp[-4].minor);
  yy_destructor(yypParser,3,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
{  yy_destructor(yypParser,105,&yymsp[-19].minor);
#line 4528 "volumeExprLemonParser.lyy"
{
...
#line 14379 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-18].minor);
  yy_destructor(yypParser,3,&yymsp[-16].minor);
  yy_destructor(yypParser,3,&yymsp[-14].minor);
  yy_destructor(yypParser,3,&yymsp[-12].minor);
...
{  yy_destructor(yypParser,106,&yymsp[-13].minor);
#line 4551 "volumeExprLemonParser.lyy"
{
...
#line 14409 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-12].minor);
  yy_destructor(yypParser,3,&yymsp[-10].minor);
  yy_destructor(yypParser,3,&yymsp[-8].minor);
  yy_destructor(yypParser,3,&yymsp[-6].minor);
...
{  yy_destructor(yypParser,107,&yymsp[-3].minor);
#line 4567 "volumeExprLemonParser.lyy"
{
...
#line 4685 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy83 = yymsp[-4].minor.yy83; // no-op
}
#line 14682 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,121,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4690 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy104 = yymsp[-4].minor.yy104; // no-op
}
#line 14694 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,121,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4710 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy223 = driver->newPointField<Foam::vector>().ptr();
...
#line 14741 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,108,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4722 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy223 = driver->newPointField<Foam::vector>().ptr();
...
#line 14760 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,109,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4734 "volumeExprLemonParser.lyy"
{
    yylhsminor.yy223 = driver->newPointField<Foam::vector>().ptr();
...
#line 14779 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,25,&yymsp[-3].minor);
  yy_destructor(yypParser,110,&yymsp[-2].minor);
  yy_destructor(yypParser,1,&yymsp[-1].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
...
#line 4748 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy94 = driver->cellToPoint(make_obj(yymsp[-1].minor.yy31)).ptr();
}
#line 14792 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,126,&yymsp[-3].minor);
#line 4758 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy67 = driver->cellToPoint(make_obj(yymsp[-1].minor.yy4)).ptr();
}
#line 14814 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,126,&yymsp[-3].minor);
#line 4763 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy83 = driver->cellToPoint(make_obj(yymsp[-1].minor.yy122)).ptr();
}
#line 14825 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
{  yy_destructor(yypParser,126,&yymsp[-3].minor);
#line 4768 "volumeExprLemonParser.lyy"
{
    yymsp[-3].minor.yy104 = driver->cellToPoint(make_obj(yymsp[-1].minor.yy37)).ptr();
}
#line 14836 "volumeExprLemonParser.cc"
  yy_destructor(yypParser,1,&yymsp[-2].minor);
  yy_destructor(yypParser,2,&yymsp[0].minor);
}
        break;
...
#line 104 "volumeExprLemonParser.lyy"
 driver->reportFatal("Parse failure, giving up..."); 
#line 14885 "volumeExprLemonParser.cc"
...
#line 105 "volumeExprLemonParser.lyy"
 driver->reportFatal("Syntax error"); 
#line 14906 "volumeExprLemonParser.cc"
...
#line 4783 "volumeExprLemonParser.lyy"
...
#line 15273 "volumeExprLemonParser.cc"
