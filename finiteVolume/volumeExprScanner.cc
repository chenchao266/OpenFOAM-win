...
//#line688 "volumeExprScanner.rl"
   /* ^^^ FSM initialization here ^^^ */;

    
//#line572 "volumeExprScanner.cc"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
//#line320 "volumeExprScanner.rl"
	...
	goto st11;
tr8:
//#line385 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(EQUAL); }}
	goto st11;
tr9:
//#line439 "volumeExprScanner.rl"
	{{p = ((te))-1;}{ EMIT_TOKEN(TENSOR); }}
	goto st11;
tr11:
//#line447 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(UNIT_TENSOR); }}
	goto st11;
tr12:
//#line388 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(LOR); }}
	goto st11;
tr16:
//#line370 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(PERCENT); }}
	goto st11;
tr19:
//#line371 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(LPAREN); }}
	goto st11;
tr20:
//#line372 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(RPAREN); }}
	goto st11;
tr21:
//#line373 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(TIMES); }}
	goto st11;
tr22:
//#line374 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(PLUS); }}
	goto st11;
tr23:
//#line376 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(COMMA); }}
	goto st11;
tr24:
//#line375 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(MINUS); }}
	goto st11;
tr26:
//#line378 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(DIVIDE); }}
	goto st11;
tr28:
//#line380 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(COLON); }}
	goto st11;
tr32:
//#line379 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(QUESTION); }}
	goto st11;
tr35:
//#line391 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(BIT_XOR); }}
	goto st11;
tr52:
//#line364 "volumeExprScanner.rl"
	{te = p;p--;}
	goto st11;
tr53:
//#line369 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(NOT); }}
	goto st11;
tr54:
//#line386 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(NOT_EQUAL); }}
	goto st11;
tr55:
//#line389 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(BIT_AND); }}
	goto st11;
tr56:
//#line387 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(LAND); }}
	goto st11;
tr57:
//#line377 "volumeExprScanner.rl"
...
//#line348 "volumeExprScanner.rl"
	...
	goto st11;
tr63:
//#line381 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(LESS); }}
	goto st11;
tr64:
//#line382 "volumeExprScanner.rl"
	{te = p+1;{ EMIT_TOKEN(LESS_EQ); }}
	goto st11;
tr65:
//#line383 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(GREATER); }}
	goto st11;
tr66:
//#line384 "volumeExprScanner.rl"
...
//#line1 "NONE"
	...
	goto st11;
tr83:
//#line413 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(ATAN); }}
	goto st11;
tr98:
//#line409 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(COS); }}
	goto st11;
tr115:
//#line402 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(LOG); }}
	goto st11;
tr122:
//#line418 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(MAG); }}
	goto st11;
tr129:
//#line422 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(NEG); }}
	goto st11;
tr135:
//#line421 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(POS); }}
	goto st11;
tr154:
//#line408 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(SIN); }}
	goto st11;
tr170:
//#line405 "volumeExprScanner.rl"
	{te = p;p--;{ EMIT_TOKEN(SQR); }}
	goto st11;
tr186:
//#line410 "volumeExprScanner.rl"
...
//#line1 "NONE"
	{te = p+1;}
//#line444 "volumeExprScanner.rl"
	{act = 65;}
	goto st23;
tr78:
//#line1 "NONE"
	{te = p+1;}
//#line412 "volumeExprScanner.rl"
	{act = 40;}
	goto st23;
tr80:
//#line1 "NONE"
	{te = p+1;}
//#line411 "volumeExprScanner.rl"
	{act = 39;}
	goto st23;
tr84:
//#line1 "NONE"
	{te = p+1;}
//#line414 "volumeExprScanner.rl"
	{act = 42;}
	goto st23;
tr89:
//#line1 "NONE"
	{te = p+1;}
//#line430 "volumeExprScanner.rl"
	{act = 55;}
	goto st23;
tr92:
//#line1 "NONE"
	{te = p+1;}
//#line437 "volumeExprScanner.rl"
	{act = 60;}
	goto st23;
tr96:
//#line1 "NONE"
	{te = p+1;}
//#line407 "volumeExprScanner.rl"
	{act = 35;}
	goto st23;
tr99:
//#line1 "NONE"
	{te = p+1;}
//#line416 "volumeExprScanner.rl"
	{act = 44;}
	goto st23;
tr106:
//#line1 "NONE"
	{te = p+1;}
//#line399 "volumeExprScanner.rl"
	{act = 27;}
	goto st23;
tr108:
//#line1 "NONE"
	{te = p+1;}
//#line401 "volumeExprScanner.rl"
	{act = 29;}
	goto st23;
tr112:
//#line1 "NONE"
	{te = p+1;}
//#line446 "volumeExprScanner.rl"
	{act = 67;}
	goto st23;
tr117:
//#line1 "NONE"
	{te = p+1;}
//#line403 "volumeExprScanner.rl"
	{act = 31;}
	goto st23;
tr121:
//#line1 "NONE"
	{te = p+1;}
//#line429 "volumeExprScanner.rl"
	{act = 54;}
	goto st23;
tr125:
//#line1 "NONE"
	{te = p+1;}
//#line419 "volumeExprScanner.rl"
	{act = 47;}
	goto st23;
tr126:
//#line1 "NONE"
	{te = p+1;}
//#line428 "volumeExprScanner.rl"
	{act = 53;}
	goto st23;
tr130:
//#line1 "NONE"
	{te = p+1;}
//#line424 "volumeExprScanner.rl"
	{act = 51;}
	goto st23;
tr131:
//#line1 "NONE"
	{te = p+1;}
//#line398 "volumeExprScanner.rl"
	{act = 26;}
	goto st23;
tr134:
//#line1 "NONE"
	{te = p+1;}
//#line404 "volumeExprScanner.rl"
	{act = 32;}
	goto st23;
tr136:
//#line1 "NONE"
	{te = p+1;}
//#line423 "volumeExprScanner.rl"
	{act = 50;}
	goto st23;
tr144:
//#line1 "NONE"
	{te = p+1;}
//#line400 "volumeExprScanner.rl"
	{act = 28;}
	goto st23;
tr145:
//#line1 "NONE"
	{te = p+1;}
//#line434 "volumeExprScanner.rl"
	{act = 59;}
	goto st23;
tr153:
//#line1 "NONE"
	{te = p+1;}
//#line425 "volumeExprScanner.rl"
	{act = 52;}
	goto st23;
tr155:
//#line1 "NONE"
	{te = p+1;}
//#line415 "volumeExprScanner.rl"
	{act = 43;}
	goto st23;
tr168:
//#line1 "NONE"
	{te = p+1;}
//#line441 "volumeExprScanner.rl"
	{act = 64;}
	goto st23;
tr171:
//#line1 "NONE"
	{te = p+1;}
//#line406 "volumeExprScanner.rl"
	{act = 34;}
	goto st23;
tr172:
//#line1 "NONE"
	{te = p+1;}
//#line431 "volumeExprScanner.rl"
	{act = 56;}
	goto st23;
tr180:
//#line1 "NONE"
	{te = p+1;}
//#line440 "volumeExprScanner.rl"
	{act = 63;}
	goto st23;
tr187:
//#line1 "NONE"
	{te = p+1;}
//#line417 "volumeExprScanner.rl"
	{act = 45;}
	goto st23;
tr195:
//#line1 "NONE"
	{te = p+1;}
//#line448 "volumeExprScanner.rl"
	{act = 69;}
	goto st23;
tr197:
//#line1 "NONE"
	{te = p+1;}
//#line445 "volumeExprScanner.rl"
	{act = 66;}
	goto st23;
tr202:
//#line1 "NONE"
	{te = p+1;}
//#line438 "volumeExprScanner.rl"
	{act = 61;}
	goto st23;
tr215:
//#line1 "NONE"
	{te = p+1;}
//#line432 "volumeExprScanner.rl"
	{act = 57;}
	goto st23;
tr217:
//#line1 "NONE"
	{te = p+1;}
//#line433 "volumeExprScanner.rl"
	{act = 58;}
	goto st23;
st23:
	if ( ++p == pe )
