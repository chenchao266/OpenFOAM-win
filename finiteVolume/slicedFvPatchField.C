...
namespace Foam {
    ...
    tmp<fvPatchField<Type>>
        slicedFvPatchField<Type>::clone() const
    {
    ...
    template<class Type>
    tmp<Field<Type>>
        slicedFvPatchField<Type>::patchInternalField() const
    {
        NotImplemented;
    ...
    template<class Type>
    tmp<Field<Type>>
        slicedFvPatchField<Type>::patchNeighbourField() const
    {
        NotImplemented;
    ...
    template<class Type>
    tmp<Field<Type>>
        slicedFvPatchField<Type>::gradientInternalCoeffs() const
    {
        NotImplemented;
    ...
    template<class Type>
    tmp<Field<Type>>
        slicedFvPatchField<Type>::gradientBoundaryCoeffs() const
    {
        NotImplemented;
