...
namespace Foam {
    template<class Type>
    word externalCoupledMixedFvPatchField<Type>::lockName = "OpenFOAM";

    template<class Type>
    string
        externalCoupledMixedFvPatchField<Type>::patchKey = "# Patch: ";


    // * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

    template<class Type>
    fileName externalCoupledMixedFvPatchField<Type>::baseDir() const
    {
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::setMaster
    (
        const labelList& patchIDs
    )
    {
        const volFieldType<Type>& cvf =
            static_cast<const volFieldType<Type>&>(this->internalField());

        volFieldType<Type>& vf = const_cast<volFieldType<Type>&>(cvf);

        typename volFieldType<Type>::Boundary& bf = vf.boundaryFieldRef();
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::writeGeometry
    (
        OFstream& osPoints,
        OFstream& osFaces
    ) const
    ...
    template<class Type>
    fileName externalCoupledMixedFvPatchField<Type>::lockFile() const
    {
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::createLockFile() const
    {
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::removeLockFile() const
    {
        if (!master_ || !Pstream::master())
        {
            return;
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::startWait() const
    {
        ...
        const typename volFieldType<Type>::Boundary& bf =
            cvf.boundaryField();
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::wait() const
    {
        const fileName fName(lockFile());
        label found = 0;
        label totalTime = 0;
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::initialiseRead
    (
        IFstream& is
    ) const
    {
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::readData
    (
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::writeData
    (
        const fileName& transferFile
    ) const
    {
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::writeHeader
    (
        OFstream& os
    ) const
    {
    ...
    template<class Type>
    externalCoupledMixedFvPatchField<Type>::
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::initialise
    (
        const fileName& transferFile
    )
    {
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::evaluate
    (
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::transferData
    (
        OFstream& os
    ) const
    {
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::writeGeometry() const
    {
        const volFieldType<Type>& cvf =
            static_cast<const volFieldType<Type>&>(this->internalField());
    ...
    template<class Type>
    void externalCoupledMixedFvPatchField<Type>::write(Ostream& os) const
    {
