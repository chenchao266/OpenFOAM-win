...
namespace Foam {
    ...
    template<class Type>
    tmp<Field<Type>>
        fvPatchField<Type>::patchInternalField() const
    {
    ...
    template<class Type>
    void fvPatchField<Type>::patchInternalField(Field<Type>& pif) const
    {
    ...
    template<class Type>
    void fvPatchField<Type>::updateWeightedCoeffs(const scalarField& weights)
    {
    ...
    template<class Type>
    void fvPatchField<Type>::manipulateMatrix
    (
    ...
    void fvPatchField<Type>::writeEntryIfDifferent
    (
        Ostream& os,
