...
namespace Foam {
    ...
    template<class Type>
    bool cyclicAMIFvPatchField<Type>::coupled() const
    {
    ...
    template<class Type>
    tmp<Field<Type>>
        cyclicAMIFvPatchField<Type>::patchNeighbourField() const
    {
    ...
    const cyclicAMIFvPatchField<Type>&
        cyclicAMIFvPatchField<Type>::neighbourPatchField() const
    {
    ...
    template<class Type>
    void cyclicAMIFvPatchField<Type>::write(Ostream& os) const
    {
