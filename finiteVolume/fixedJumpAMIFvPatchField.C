...
namespace Foam {
    template<class Type>
    fixedJumpAMIFvPatchField<Type>::fixedJumpAMIFvPatchField
    (
        const fvPatch& p,
    ...
    template<class Type>
    tmp<Field<Type>> fixedJumpAMIFvPatchField<Type>::jump() const
    {
        if (this->cyclicAMIPatch().owner())
        {
            return jump_;
    ...
    template<class Type>
    void fixedJumpAMIFvPatchField<Type>::autoMap
    (
    ...
    template<class Type>
    void fixedJumpAMIFvPatchField<Type>::rmap
    (
    ...
    template<class Type>
    void fixedJumpAMIFvPatchField<Type>::write(Ostream& os) const
    {
