...
{
    flowSens_ = vector::zero_;
    dSdbSens_ = vector::zero_;
    dndbSens_ = vector::zero_;
    dxdbDirectSens_ = vector::zero_;
    dVdbSens_ = vector::zero_;
    distanceSens_ = vector::zero_;
    optionsSens_ = vector::zero_;
    bcSens_ = vector::zero_;
