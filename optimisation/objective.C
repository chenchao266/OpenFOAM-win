...
void objective::nullify()
{
    if (!nullified_)
    {
        ...
        if (hasBoundarydJdb())
        {
            bdJdbPtr_() == vector::zero_;
        }
        if (hasdSdbMult())
        {
            bdSdbMultPtr_() == vector::zero_;
        }
        if (hasdndbMult())
        {
            bdndbMultPtr_() == vector::zero_;
        }
        if (hasdxdbMult())
        {
            bdxdbMultPtr_() == vector::zero_;
        }
        if (hasdxdbDirectMult())
        {
            bdxdbDirectMultPtr_() == vector::zero_;
        }
        if (hasBoundaryEdgeContribution())
        {
